---
title: "ADHD and School: System Limits in the US and UK"
description: "ADHD and school in the US and UK: what IEPs, 504 plans, SEN Support and EHCPs actually deliver, where the system breaks down, and how families push back."
excerpt: "On paper, US and UK schools protect ADHD students. In practice, the gap between law and classroom is where families live."
pubDate: 2026-07-16
updatedDate: 2026-07-16
tags: ["ADHD", "school", "education", "advocacy"]
locale: en
draft: false
author: "DopaHop"
...
DopaHop is built for adults with ADHD, including parents, and the bits that tend to help most in this context are the gentle ones: a [brain dump](/#cosa-fa) for the thoughts that arrive during a school meeting and would otherwise vanish by the time you reach the car; [medication reminders](/#cosa-fa) that don't shame you when you skip; a [mood check-in](/#cosa-fa) so you can see, after a brutal week of phone calls and forms, whether it's the situation that's heavy or whether you also need to look after yourself. None of this fixes the system. It just stops the system from also eating the parent.

If you suspect your own ADHD has been quietly running the show, our pieces on [late ADHD diagnosis](/blog/adhd-late-diagnosis-causes-consequences/) and [ADHD in parents](/blog/adhd-parents-family-impact/) are written for exactly this moment.
