---
title: "ADHD Sleep: Disrupted Circadian Rhythms, Explained"
description: "ADHD sleep problems are biological, not lifestyle. Why melatonin runs late, why standard sleep hygiene often fails, and what actually helps."
excerpt: "If you have ADHD and can't sleep, it's not because you have bad habits. Here's what's really going on."
pubDate: 2026-05-25
...
The clinical literature behind this is substantial. CHADD, ADDA, and the AASM all recognise sleep as a core ADHD-adjacent issue rather than a comorbidity that just "happens to show up." See also: [ADHD Executive Functions: What Actually Breaks Down](/en/blog/adhd-executive-functions-what-breaks/) — many of the same prefrontal circuits that struggle with task initiation also struggle with the "shutdown" sequence at night.
...
If your wind-down keeps getting hijacked by the thought "wait, I forgot to write that down" — try a [brain dump](/#cosa-fa) ten minutes before you switch off. Not a journaling practice. Just emptying the inbox in your head onto something external so it stops looping.

## How DopaHop fits in

We're an ADHD app, not a sleep clinic. Three modules tend to be useful around the sleep problem:

- **[Brain dump](/#cosa-fa)** — for the 11 p.m. "I just remembered" loop. Ten seconds, it's out of your head, you can deal with it tomorrow.
- **[Focus sounds](/#cosa-fa)** — brown noise, rain, lo-fi for wind-down or for masking a noisy household.
- **[Medication reminders](/#cosa-fa)** — three buttons (Taken / In 10 min / Skipped). No nagging, no guilt loop if you missed yesterday's evening dose.
