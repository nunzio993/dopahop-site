---
title: "ADHD Procrastination: The Real Mechanism, Not Laziness"
description: "ADHD procrastination isn't laziness. The real mechanism: time blindness, dopamine-driven motivation, and decision paralysis — plus what actually helps."
excerpt: "If you have ADHD and can't start the task you care about, it isn't laziness. Here's what's actually going on."
pubDate: 2026-05-19
...
See also: [ADHD Dopamine: The Neurobiological Model Explained](/en/blog/adhd-dopamine-neurobiological-model/).
...
If decision paralysis is your main bottleneck, [the Spacca-task module in DopaHop](/#cosa-fa) walks you through breaking a task into five concrete steps with a short wizard, so the first step is already chosen for you when you sit down.
...
4. **Treat the underlying ADHD if you haven't.** Stimulants like methylphenidate and amphetamine-class medications — or atomoxetine for those who can't tolerate stimulants — directly target the dopamine and noradrenaline systems described above. Per [NICE NG87](https://www.nice.org.uk/guidance/ng87) (UK) and [NIMH](https://www.nimh.nih.gov/health/topics/attention-deficit-hyperactivity-disorder-adhd) (US), pharmacological treatment is first-line for adult ADHD with significant functional impairment, alongside psychoeducation and CBT. If procrastination is wrecking your work or relationships, this is worth a conversation with your psychiatrist (US) or your GP for referral to an adult ADHD service (UK). Resources from [CHADD](https://chadd.org/about-adhd/overview/) and [ADDA](https://add.org/adhd-facts/) can help you prepare for that conversation.
...
See also: [ADHD Executive Functions: What Actually Breaks Down](/en/blog/adhd-executive-functions-what-breaks/).

## How DopaHop fits in

A few modules map directly onto the mechanisms above:

- **[Pomodoro](/#cosa-fa)**: a 25-minute timer that starts the moment you press go. Externalises time, lowers the starting cost, no setup decisions to stall on.
- **[Brain dump](/#cosa-fa)**: ten seconds to offload a thought before it disappears. Useful when the reason you can't start the main task is that six other tasks are bouncing around in working memory.
- **[Focus sounds](/#cosa-fa)**: rain, lo-fi, brown noise. The novelty/stimulation pairing that helps boring tasks clear the dopaminergic threshold.
...
If you want a place to start tomorrow, just one thing: try the [Pomodoro](/#cosa-fa) timer for one task you've been putting off. Twenty-five minutes. The goal isn't to finish — it's to start, badly, on purpose. DopaHop is free on Google Play, and Hop waits, even after a hard week.
