---
title: "Inattentive vs Hyperactive ADHD: Functional Differences"
description: "Inattentive vs hyperactive ADHD: what really differs in daily life, where the two presentations overlap, and what to do when you fit both."
excerpt: "Same diagnosis, two very different daily lives. Here's what actually changes between presentations."
pubDate: 2026-05-10
...
For adults (17+), the threshold drops to five symptoms in either column, which the DSM-5-TR added precisely because adults often present with fewer overt signs than kids. [CHADD](https://chadd.org/about-adhd/overview/) has a clear plain-English breakdown if you want to read the actual criteria. The presentation isn't a permanent label, either — it can shift over a lifetime. Many adults who were diagnosed hyperactive at age seven are very clearly "inattentive type" by thirty-five, mostly because the hyperactivity went internal.

See also: [ADHD: DSM-5 Diagnostic Criteria, Explained Plainly](/en/blog/adhd-dsm-5-criteria/) for the full criteria walkthrough.
...
In adults, the visible jumping-around often calms down. What replaces it is internal restlessness: the leg-jiggle, the constant tab-switching, the inability to sit still during a video call without doing something with your hands. [NICE NG87](https://www.nice.org.uk/guidance/ng87) — the UK clinical guideline — explicitly notes that hyperactivity in adults often manifests as inner restlessness rather than gross motor activity, which is exactly why so many adults assume they "outgrew" their ADHD when really they just internalized it.
...
Underneath the surface, both presentations are running on the same underlying machinery — and the same machinery is misfiring. The current model from the [NIMH](https://www.nimh.nih.gov/health/topics/attention-deficit-hyperactivity-disorder-adhd) treats ADHD as a disorder of self-regulation, with disruptions in the dopamine and norepinephrine systems that feed the prefrontal cortex. That cluster of systems handles things like:
...
See also: [ADHD Executive Functions: What Actually Breaks Down](/en/blog/adhd-executive-functions-what-breaks/) for a deeper dive on the systems both presentations share.
...
Across all presentations, the formal evidence base — well summarized by [CHADD's treatment overview](https://chadd.org/about-adhd/treatment-of-adhd/) — points to the same combination: medication where appropriate, structured behavioral strategies, and environmental adjustments. None of those replace each other.

## How DopaHop can help

A few modules map cleanly to the patterns above:

- **[Pomodoro](/#what-it-does)** — useful for the inattentive "I can't start" wall and the hyperactive "I can't sit still long enough to finish" wall. Same tool, different purpose.
- **[Brain dump](/#what-it-does)** — built for the inattentive habit of losing a thought before you can act on it, and equally useful for the hyperactive habit of having ten thoughts at once.
- **[Focus sounds](/#what-it-does)** — a small amount of constant audio (rain, lo-fi, brown noise) helps both presentations: it gives the inattentive brain something to anchor to, and the hyperactive brain something to absorb the leftover restlessness.
