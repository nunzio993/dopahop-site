---
title: "ADHD and Creativity: Real Correlation or Just a Story?"
description: "ADHD and creativity gets sold as a superpower. The research is messier — divergent thinking sometimes scores higher, finishing rarely does. Here's the honest read."
excerpt: "ADHD as a creative superpower? The research is more nuanced — and the framing leaves a lot of people behind."
pubDate: 2026-06-26
updatedDate: 2026-06-26
tags: ["ADHD", "creativity", "divergent thinking", "neurodivergence"]
locale: en
draft: false
author: "DopaHop"
...
Realisational creativity leans heavily on **executive function**: working memory to hold the plan, task initiation to start each session, sustained attention to push through the unrewarding bits, and emotional regulation to survive the parts where the work isn't working. These are the systems that tend to misfire in ADHD (see [ADHD Executive Functions: What Actually Breaks Down](/blog/adhd-executive-functions-what-breaks/) for what's going on under the hood).
...
- **It minimises real impairment.** ADHD is recognised as a disorder by [CHADD](https://chadd.org/), [ADDA](https://add.org/), and clinical guidelines including [NICE NG87](https://www.nice.org.uk/guidance/ng87) precisely because it causes meaningful functional impact across work, relationships, and health. Calling that a superpower in disguise can make it harder to ask for accommodations, medication, or therapy without feeling like you're betraying your own "gift."
...
If you can't get a real human, structured time blocks with a defined start and stop ([the Pomodoro from DopaHop](/#cosa-fa) is one cheap version) can do some of the same work — they create an external container that says "for the next 25 minutes, this is the thing." It's not a fix for the disorder. It's a scaffold for getting one specific session done.
...
- **[Brain dump](/#cosa-fa)** — for the immediate capture step. Ten seconds, idea is out, you can stop holding it. Later you decide if it's a task, a project seed, or nothing.
- **[Pomodoro](/#cosa-fa)** — for the execution scaffold. A 25-minute container so that "work on the project" becomes a concrete, finishable session instead of an endless intention.
