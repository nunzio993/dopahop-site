---
title: "ADHD and Working Memory: The Real, Measurable Limits"
description: "ADHD working memory isn't broken — it's structurally smaller. What the research shows, how it shows up daily, and the strategies that actually hold up."
excerpt: "Forgetting why you walked in isn't bad memory. It's a working memory limit — and it's measurable."
pubDate: 2026-06-22
updatedDate: 2026-06-22
tags: ["ADHD", "working memory", "executive functions", "cognitive science"]
locale: en
draft: false
author: "DopaHop"
...
This matches what executive function researchers have been saying for years — see also our piece on [ADHD executive functions: what actually breaks down](/en/blog/adhd-executive-functions-what-breaks/) for the broader picture of which mental systems are involved.
...
If your brain keeps recycling "don't forget to email Marco, don't forget to email Marco" while you're trying to do something else, the recycling itself is using working memory. Write it down anywhere and the slot frees up. If you want a low-friction way to do this on the move, [DopaHop's brain dump](/#cosa-fa) is built for exactly this — ten seconds, thought out of head, you decide later what to do with it.
...
- **Single-task on purpose.** Switching between tasks costs working memory each time — see also our piece on [ADHD and multitasking: myth vs. reality](/en/blog/adhd-multitasking-myth-vs-reality/) for why the "switching tax" lands harder on ADHD brains.
...
For US-based readers, CHADD ([chadd.org](https://chadd.org/)) and ADDA ([add.org](https://add.org/)) both have evidence-based explainers on executive function and working memory. For UK readers, NICE guideline NG87 covers the clinical framework. The American Psychological Association also publishes accessible summaries of the cognitive research.
