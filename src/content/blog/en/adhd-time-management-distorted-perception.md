---
title: "ADHD and Time Management: Distorted Time Perception"
description: "ADHD time blindness isn't bad planning — it's distorted time perception. The mechanism, how it shows up, and strategies that hold up on hard days."
excerpt: "Time blindness isn't a planning failure. It's a different way the ADHD brain perceives minutes and hours."
pubDate: 2026-06-20
updatedDate: 2026-06-20
tags: ["ADHD", "time blindness", "time management", "executive function"]
locale: en
draft: false
author: "DopaHop"
...
- **Working memory** has to hold "the plan" online while time passes. If working memory is fragile (and in ADHD it often is — see [ADHD Executive Functions: What Actually Breaks Down](/en/blog/adhd-executive-functions-what-breaks/)), the plan drops out of mind, and with it the sense of where you are in the timeline.
...
- **Time disappearing into a task.** You sit down to "check one thing" and surface ninety minutes later. This is the same dysregulated attention that powers hyperfocus — see [ADHD and Hyperfocus: Advantage or Trap, Honestly?](/en/blog/adhd-hyperfocus-advantage-or-trap/) — and time perception goes with it.
...
This also overlaps heavily with how ADHD procrastination actually works (the dopamine and time-horizon piece), explored in [ADHD Procrastination: The Real Mechanism, Not Laziness](/en/blog/adhd-procrastination-real-mechanism/). Treating either as a motivation problem keeps you trying solutions that were never built for the actual mechanism.
...
If you want a single tool that quietly externalizes time without being naggy, the [Pomodoro in DopaHop](/en/#cosa-fa) is a low-friction starting point — you press start, the timer runs by itself, and the boundary isn't yours to negotiate with. Pair it with a visible timer and you've covered most of the daily damage.
