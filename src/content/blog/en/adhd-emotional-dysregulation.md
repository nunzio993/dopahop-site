---
title: "ADHD Emotional Dysregulation: Why Feelings Hit Hard"
description: "ADHD emotional dysregulation: why feelings land harder and faster, what DSM-5-TR says (and doesn't), the DESR model, and strategies that actually help."
excerpt: "Big feelings, fast feelings, no off switch. Why emotional dysregulation lives at the core of ADHD."
pubDate: 2026-05-22
...
See also: [ADHD DSM-5 Criteria: What Actually Counts for Diagnosis](/en/blog/adhd-dsm-5-criteria/).
...
1. **Inhibiting the immediate emotional response** to a trigger before it takes over the system.
2. **Self-soothing** to bring the intensity down once it's started.
3. **Refocusing attention** away from the emotional trigger and onto something else.
4. **Substituting a more measured response** for the raw initial one.
...
A two-second mood and energy check, several times a day, is one of the lowest-effort interventions that genuinely shifts this. If a structured prompt helps, [the DopaHop mood check-in](/#cosa-fa) takes three taps — how you're doing, energy level, an optional tag — and shows you the weekly pattern. The point isn't journaling. It's noticing the trend before the trend takes over the day.
...
If a low-friction way to track the trend would help, [the DopaHop mood check-in](/#cosa-fa) is built for this exact pattern: three taps, no diary, no streaks. Hop is on Google Play, free, and waits for you — even after a rough week.
