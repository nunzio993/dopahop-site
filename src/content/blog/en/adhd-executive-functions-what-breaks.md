---
title: "ADHD Executive Functions: What Actually Breaks Down"
description: "ADHD executive function: the systems that misfire (working memory, task initiation, emotional regulation), why willpower won't fix them, what helps."
excerpt: "It's not laziness. It's the systems behind 'just do the thing' — and how they break in ADHD."
pubDate: 2026-05-07
...
Researchers split them up slightly differently depending on who you ask — [CHADD](https://chadd.org/about-adhd/executive-function-skills/) is a good general resource on EF — and the eight-item shortlist popularized by Dawson and Guare in the clinical literature is one of the most usable:
...
ADHD is a neurodevelopmental condition (per the [National Institute of Mental Health](https://www.nimh.nih.gov/health/topics/attention-deficit-hyperactivity-disorder-adhd) and the UK's [NICE guideline NG87](https://www.nice.org.uk/guidance/ng87)); the underlying neurobiology, summarized in peer-reviewed work like [Del Campo et al. 2011](https://pubmed.ncbi.nlm.nih.gov/21550021/), involves differences in how the brain's dopamine and norepinephrine systems regulate attention and motivation. The prefrontal cortex — the executive function HQ — relies heavily on these neurotransmitters to do its job.
...
See also: [Childhood ADHD vs Adult ADHD: How It Shifts Over Time](/en/blog/adhd-children-vs-adults/), which goes deeper into how these patterns morph from kid you to adult you.

## What doesn't work (even though it gets recommended)
...
The honest answer is that there's no single fix. Adult ADHD usually responds best to a **stack** of small supports, ideally including clinical input. The CHADD overview of [adult ADHD treatment](https://chadd.org/for-adults/treatment/) frames it the same way: medication, therapy (especially CBT for ADHD), and environmental scaffolding tend to work together, not as alternatives.

A few patterns that consistently help:

1. **Externalize working memory.** If your head can't hold it, get it out of your head. Quick capture beats elaborate systems. Anything you'd otherwise lose — a sudden idea, a thing you need to remember to buy, a feeling you want to revisit — should land somewhere outside your skull within ten seconds. For that, [the brain dump in DopaHop](/#cosa-fa) is built for one job: thought in, thought saved, ten seconds, no friction. You go back to it later when you have brain to spare.
...
Not quite. Executive dysfunction is a *feature* of ADHD, but it also shows up in autism, depression, traumatic brain injury, severe anxiety, and several other conditions. ADHD has executive dysfunction plus a specific pattern of inattention and/or hyperactivity-impulsivity that meets diagnostic criteria. See also: [ADHD: DSM-5 Diagnostic Criteria, Explained Plainly](/en/blog/adhd-dsm-5-criteria/) for the full picture.
