---
title: "ADHD and Multitasking: Myth vs. Reality of Switching"
description: "ADHD multitasking isn't real multitasking — it's expensive task-switching, and the cost hits ADHD brains harder. Here's what's happening and how to reduce it."
excerpt: "You're not bad at multitasking. Nobody's good at it. But ADHD makes the switching cost louder."
pubDate: 2026-06-16
updatedDate: 2026-06-16
tags: ["ADHD", "multitasking", "productivity", "task switching"]
locale: en
draft: false
author: "DopaHop"
...
If you want a deeper look at which specific systems are involved, we wrote about this in [ADHD Executive Functions: What Actually Breaks Down](/en/blog/adhd-executive-functions-what-breaks/) — working memory and task initiation are the two big ones for switching.
...
If you're recognising this from your job, the spikes-and-valleys pattern is covered in more depth in [ADHD Work: Why Performance Comes in Waves, Not Lines](/en/blog/adhd-work-discontinuous-performance/).
...
A scratch pad next to the keyboard. A note on your phone. Whatever. The point is: the moment a "I should also…" thought appears, it goes onto the external surface within five seconds, and you go back to the current task. If you tend to lose those thoughts before you've even decided what to do with them, [the brain dump in DopaHop](/en/#cosa-fa) is built for exactly this — ten seconds, thought captured, you decide later whether it's a task, a list item, or nothing.
