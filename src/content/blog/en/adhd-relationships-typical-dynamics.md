---
title: "ADHD Relationships: Typical Dynamics That Show Up"
description: "ADHD relationships have recognisable patterns: hyperfocus then distance, RSD in conflict, parent-child drift, body doubling. What's going on, and what helps."
excerpt: "From hyperfocus to forgotten plans: the patterns that quietly shape ADHD relationships, and how to work with them."
pubDate: 2026-06-10
updatedDate: 2026-06-10
tags: ["ADHD", "relationships", "RSD", "communication"]
locale: en
draft: false
author: "Nunzio C."
...
Working memory is one of the executive functions that most reliably misfires in ADHD ([CHADD on executive function](https://chadd.org/about-adhd/executive-function-skills/)). For the person with ADHD, "I forgot" is usually a literal, neutral statement. For the person on the other side, it almost never lands neutrally.
...
What helps, in practice, is moving important details out of memory and into shared external systems: a visible calendar, a shared list, a recurring reminder set the moment a plan is made — not later. The promise becomes "let me put this in my phone right now while we're talking," not "of course I'll remember." If thoughts evaporate before you can write them down, the [brain dump in DopaHop](/#cosa-fa) is built for that exact ten-second window.

## RSD in conflict: small comments, big landings

[Rejection sensitive dysphoria](https://chadd.org/adhd-weekly/rejection-can-more-painful-with-adhd/) (RSD) is a non-DSM but widely used term, coined by psychiatrist William Dodson, for the intense, fast emotional pain many ADHD adults feel in response to perceived criticism, exclusion, or disappointment. It's a downstream piece of the broader **emotional dysregulation** that lives at the core of ADHD (see also: [ADHD emotional dysregulation](/blog/adhd-emotional-dysregulation/)).
...
1. **Interrupting.** Not from rudeness — from the genuine fear that the thought will vanish if it isn't said now. By the time the other person finishes the sentence, the idea is gone.
2. **Topic drift.** A conversation that started about logistics ends up, fifteen minutes later, somewhere completely different, with the original question never answered.
...
- **For UK readers**, NICE NG87 covers adult ADHD assessment ([recommendation 1.3.4](https://www.nice.org.uk/guidance/ng87)) and non-pharmacological support including structured psychological intervention and CBT ([recommendations 1.5.16–1.5.18](https://www.nice.org.uk/guidance/ng87)); medication options including stimulants are covered in [1.7.11–1.7.15](https://www.nice.org.uk/guidance/ng87). For US readers, [CHADD](https://chadd.org/), [ADDA](https://add.org/), and [NIMH](https://www.nimh.nih.gov/health/topics/attention-deficit-hyperactivity-disorder-adhd) are good starting points.
