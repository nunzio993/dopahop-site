---
title: "ADHS Angst: Komorbidität und diagnostische Verwirrung"
description: "ADHS und Angst treten bei rund der Hälfte der Erwachsenen gemeinsam auf. So unterscheidest du die Symptome und findest eine passende Behandlung."
excerpt: "Wenn ADHS und Angststörung sich überlagern, hilft kein Entweder-oder, sondern genaues Hinsehen."
pubDate: 2026-06-03
...
- **ADHS** ist im Kern eine Störung der exekutiven Funktionen und der Aufmerksamkeitssteuerung. Die Schwierigkeit, etwas zu beginnen, hängt mit Dopamin- und Aufmerksamkeitsregulation zusammen, nicht mit einer drohenden Katastrophe im Kopf. Vergleiche dazu auch unseren Artikel zu [exekutiven Funktionen bei ADHS](/blog/adhd-executive-functions-what-breaks/).
...
1. **"Es ist nur Angst."** Du gehst wegen Panikattacken oder Grübeln in Behandlung, bekommst eine Angststörung diagnostiziert — und die zugrunde liegende ADHS bleibt unerkannt. Therapie hilft, aber nur teilweise. Konzentrationsprobleme, Vergesslichkeit und das Gefühl, "nicht hinterherzukommen", bleiben.
2. **"Es ist nur ADHS."** Die ADHS-Diagnose kommt im Erwachsenenalter, du beginnst Behandlung — und merkst, dass die Angst trotz besserer Aufmerksamkeit bleibt. Hier liegt oft eine eigenständige Angststörung darunter, die zusätzlich behandelt werden muss.
...
Wenn dich an manchen Tagen schon das Gefühl überrollt, gar nicht zu wissen, womit du anfangen sollst, kann es helfen, einen kleinen Anker zu haben: ein [Brain dump in DopaHop](/#cosa-fa) ist in zehn Sekunden gemacht, du musst nichts ordnen, nichts bewerten — nur den Kopf einmal leeren. Das ersetzt keine Therapie, aber es senkt die Schwelle, einen unruhigen Moment nicht in einer Sorgenspirale enden zu lassen.
