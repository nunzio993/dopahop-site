---
title: "ADHS Selbstwert: Aufbau, Verzerrungen, Wiederaufbau"
description: "ADHS Selbstwert: warum er bei vielen Erwachsenen fragil wird, welche Verzerrungen typisch sind und welche Schritte beim Wiederaufbau wirklich tragen."
excerpt: "Wenn jeder Tag eine kleine Niederlage ist, wird Selbstwert zur Mangelware — was wirklich hilft."
pubDate: 2026-06-08
...
Die deutsche **S3-Leitlinie ADHS** (federführend DGKJP, DGPPN, DGSPJ; AWMF-Register 028-045; die 2018-Fassung ist formal im Mai 2022 abgelaufen und befindet sich in Revision) beschreibt negatives Selbstbild und sekundäre psychische Belastungen explizit als typische Folge eines lange unerkannten ADHS, gerade im Erwachsenenalter. Auch **ADHS Deutschland e.V.** und das [zentrale adhs-netz](https://www.zentrales-adhs-netz.de/) thematisieren das fragile Selbstwertgefühl seit Jahren als zentrales Begleitthema.

Vergleiche dazu auch unseren Beitrag zu [später ADHS-Diagnose und ihren realen Folgen](/blog/adhd-late-diagnosis-causes-consequences/) — vieles, was dort über Selbstbild geschrieben steht, ist die Vorstufe der Selbstwertfrage.
...
**Verzögerte und unzuverlässige Rückmeldungen vom eigenen Verhalten.** Bei ADHS funktioniert die innere Vorhersage *"Wenn ich das jetzt mache, wird mir das später guttun"* schwächer als bei neurotypischen Menschen. Das hat mit der dopaminergen Signalverarbeitung zu tun (siehe auch unseren Artikel zum [neurobiologischen Modell von ADHS und Dopamin](/blog/adhd-dopamine-neurobiological-model/)). Folge: Du erlebst dich seltener als jemand, der vorausschaut und Wort hält — auch wenn du es im Innern willst.
...
> Wenn du in dieser Stelle merkst, dass du regelmäßig vergisst, deine Mood- und Tagesnotizen zu machen, lohnt sich ein einfacher Anker: das [Mood-Check-in von DopaHop](/#cosa-fa) braucht drei Tippen und keine Schreibarbeit — gerade an den Tagen, an denen Tagebuch zu viel wäre.
...
- **[Mood-Check-in](/#cosa-fa)**: drei Tippen am Tag — wie es dir geht, Energie, ein optionaler Tag. Über Wochen entsteht ein Bild, das deine Tage zeigt, statt sie zu kommentieren.
- **[Brain-Dump](/#cosa-fa)**: in zehn Sekunden den selbstkritischen Gedanken aus dem Kopf bekommen, statt mit ihm zu kreisen. Du kannst ihn später in Ruhe anschauen — oft sieht er auf Distanz anders aus.
