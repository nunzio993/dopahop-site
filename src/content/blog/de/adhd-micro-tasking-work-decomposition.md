---
title: "Micro-Tasking bei ADHS: Arbeit operativ zerlegen"
description: "Micro-Tasking bei ADHS: warum große Aufgaben blockieren, wie operative Zerlegung wirklich funktioniert, typische Fehler und Werkzeuge, die im Alltag tragen."
excerpt: "Eine Aufgabe startet nicht? Wahrscheinlich ist sie nicht zu schwer — sondern zu groß."
pubDate: 2026-08-23
updatedDate: 2026-08-23
tags: ["ADHS", "Micro-Tasking", "Aufgabenzerlegung", "Produktivität", "Arbeitsgedächtnis"]
locale: de
draft: false
author: "Nunzio C."
...
Apropos Arbeitsgedächtnis: wer mehr darüber wissen will, wie diese Begrenzung konkret aussieht, kann den Artikel [ADHS Arbeitsgedächtnis: konkrete Grenzen verstehen](/de/blog/adhd-working-memory-real-limits/) lesen — er erklärt, warum sechs offene Sub-Aufgaben im Kopf fast nie funktionieren und welche Auslagerungs-Strategien die Forschung empfiehlt.
...
Wenn du beim Zerlegen merkst, dass dein Gehirn schon hier blockiert, weil zu viele Mini-Entscheidungen aufploppen, kann eine externe Struktur helfen. [Der Spacca-Task-Wizard von DopaHop](/#cosa-fa) führt dich manuell durch eine Zerlegung in fünf konkrete Schritte — kein KI-Zauber, einfach ein geordnetes Eingabe-Gerüst, das dir die Übersicht abnimmt.
...
**Pomodoro-Timer.** Klassische 25-Minuten-Blöcke mit 5 Minuten Pause. Ideal, weil jeder Micro-Task in ein einzelnes Pomodoro passen sollte. Du arbeitest nicht "an der Steuererklärung", du arbeitest "25 Minuten am Steuerordner-Sortieren". [Der Pomodoro von DopaHop](/#cosa-fa) startet auf einen Druck — ohne Konfigurations-Tunnel.

**Externes Gedächtnis.** Schreibe Zwischenstände auf, sobald du sie hast. Dein Arbeitsgedächtnis ist begrenzt, also nutze Papier, Notizapp, Sprachmemo — Hauptsache nicht den Kopf. Wer mehr dazu lesen möchte, wie genau diese Auslagerung das ADHS-Gehirn entlastet, findet im Artikel [ADHS exekutive Funktionen: was wirklich zusammenbricht](/de/blog/adhd-executive-functions-what-breaks/) die neurobiologische Logik dahinter.
