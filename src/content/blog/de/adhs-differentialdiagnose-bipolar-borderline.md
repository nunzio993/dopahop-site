---
title: "ADHS Differentialdiagnose: bipolar, Borderline, Angst"
description: "ADHS Differentialdiagnose im Erwachsenenalter: wie sich ADHS von bipolarer Störung, Borderline und generalisierter Angststörung wirklich unterscheiden lässt."
excerpt: "Drei Diagnosen, die sich mit ADHS überlappen — und wie eine saubere Abgrenzung wirklich aussieht."
pubDate: 2026-08-20
updatedDate: 2026-08-20
tags: ["ADHS", "Differentialdiagnose", "bipolar", "Borderline", "Angststörung"]
locale: de
draft: false
author: "Nunzio C."
...
| Dimension | ADHS | Borderline |
|---|---|---|
| Stimmungswechsel | Reaktiv, Minuten bis Stunden | Reaktiv plus chronische innere Leere |
| Selbstbild | Schwankendes Selbstwertgefühl, aber Identität stabil | Identitätsdiffusion, "wer bin ich eigentlich" |
| Beziehungen | Konfliktreich durch Reizbarkeit und Vergesslichkeit | Idealisierung/Entwertung, Angst vor Verlassen |
| Selbstverletzung | Nicht typisch | Häufiges Muster |
| Beginn | Symptome seit Kindheit | Pattern festigt sich in Adoleszenz/jungem Erwachsenenalter |
...
Wenn du im Alltag schon vor der Diagnose Werkzeuge brauchst, die dich nicht zusätzlich unter Druck setzen, kann eine sanfte App-Begleitung helfen: [DopaHop hat ein paar Module](/#cosa-fa) — Pomodoro, Brain dump, sanfte Erinnerungen — die für den ADHS-typischen Energiehaushalt gebaut sind, ohne Streak-Logik und ohne Schuldgefühle. Mehr dazu gleich am Schluss.

## Häufige Fragen zur Differentialdiagnose ADHS
...
Wenn du gerade in einer Abklärungsphase bist und im Alltag etwas brauchst, das dich nicht zusätzlich unter Druck setzt: [DopaHop wartet auf dich](/#widget) — ein Hop, der nie schimpft, auch wenn du eine Woche nicht reinschaust. Sanfte Werkzeuge statt Produktivitäts-Coaching.

---

*Dieser Artikel ist informativ. Eine Differentialdiagnose erfordert eine Fachperson (Psychiater oder klinischer Psychologe). Für Diagnose, Therapie oder Notfälle wende dich an deine Hausärztin oder deinen Hausarzt, an eine fachärztliche Praxis oder an eine spezialisierte Ambulanz. In einer medizinischen Notlage: 112.*
