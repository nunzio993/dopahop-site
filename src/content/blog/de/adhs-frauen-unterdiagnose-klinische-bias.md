---
title: "ADHS bei Frauen: Unterdiagnose und klinische Bias"
description: "ADHS bei Frauen wird oft spät erkannt. Warum das passiert, was es Dich kostet — und wie der Weg zur Abklärung in DE, AT und CH realistisch aussieht."
excerpt: "Mit 35, 42, 51 endlich hören, dass es ADHS ist — und nicht 'einfach Angst'."
pubDate: 2026-08-17
...
- **Vorwiegend unaufmerksame Präsentation ist häufiger.** Bei Frauen überwiegt das Erscheinungsbild ohne sichtbare motorische Hyperaktivität. Innere Unruhe statt äußerer. Dauerndes Grübeln statt Aufspringen. Das **zentrale adhs-netz** ([zentrales-adhs-netz.de](https://www.zentrales-adhs-netz.de)) weist explizit darauf hin, dass Frauen häufiger ein vorwiegend unaufmerksames Bild zeigen und entsprechend später diagnostiziert werden.
...
Siehe auch: [ADHS unaufmerksam vs hyperaktiv: was wirklich anders ist](/de/blog/adhd-inattentive-vs-hyperactive/) — dort gehen wir auf den Unterschied der beiden Präsentationen genauer ein.
...
Siehe auch: [ADHS und emotionale Dysregulation: warum die Welle so groß kommt](/de/blog/adhs-emotionale-dysregulation-heftige-gefuehle/) — dort schauen wir uns den Mechanismus genauer an.
...
ADHS Deutschland e.V. ([adhs-deutschland.de](https://www.adhs-deutschland.de)) bietet Selbsthilfegruppen — auch frauen-spezifische in mehreren Regionen — und ist oft der einfachste erste Anlaufpunkt für Erfahrungsaustausch außerhalb der medizinischen Versorgung.
...
- **Direkt zum Facharzt.** Möglich. Das **zentrale adhs-netz** ([zentrales-adhs-netz.de](https://www.zentrales-adhs-netz.de)) listet Spezialambulanzen und ADHS-erfahrene Praxen, gerade in Großstädten gibt es spezialisierte Sprechstunden für Erwachsene.
- **ADHS Deutschland e.V.** ([adhs-deutschland.de](https://www.adhs-deutschland.de)) bietet Beratung, Selbsthilfegruppen und Hinweise auf erfahrene Fachpersonen.
...
Während Du auf den Termin wartest, kann es helfen, **kleine Strukturen** in den Alltag zu legen — ohne Dich gleich umzubauen. Wenn Termine, Medikamente oder das Festhalten flüchtiger Gedanken regelmäßig untergehen, kann ein leichter [Brain Dump](/#cosa-fa) reichen, um den Druck zu senken: zehn Sekunden, raus damit, später anschauen. Kein Streak, keine Schuld.
