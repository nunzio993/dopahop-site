---
title: "ADHS Hyperfokus: Vorteil, Falle oder beides?"
description: "ADHS-Hyperfokus ist keine Superkraft. Was ihn von Flow unterscheidet, wann er kippt, und wie du ihn steuerst, ohne nach acht Stunden zusammenzubrechen."
excerpt: "Hyperfokus ist nicht magisch. Er ist dysreguliert, oft unfreiwillig, und hat einen Preis."
pubDate: 2026-06-18
...
Klinisch ist das Phänomen trotz seiner Bekanntheit erstaunlich wenig untersucht. Eine der wichtigeren Arbeiten dazu ist die Studie von [Hupfeld, Abagis und Shah (2019)](https://link.springer.com/article/10.1007/s12402-018-0272-y), in der erwachsene ADHS-Betroffene signifikant häufiger und intensiver Hyperfokus berichten als die nicht-ADHS-Kontrollgruppe — sowohl bei der Arbeit als auch bei Bildschirmaktivitäten und Hobbys. Die Autorinnen und der Autor formulieren explizit, dass Hyperfokus bei ADHS am ehesten als **dysreguliertes Aufmerksamkeitssystem** zu verstehen ist, nicht als zusätzliche Kompetenz.

[Ozel-Kizil et al. (2016)](https://pubmed.ncbi.nlm.nih.gov/27681531/) entwickelten eine erste Skala zur Messung von Hyperfokus bei Erwachsenen mit ADHS und kamen zum gleichen Schluss: Hyperfokus korreliert positiv mit ADHS-Symptomen. Anders gesagt: je ausgeprägter das ADHS, desto eher kennst du auch das andere Extrem der Aufmerksamkeitsregulation.

[Ashinoff und Abu-Akel (2021)](https://link.springer.com/article/10.1007/s00426-019-01245-8) gehen in ihrem Review noch einen Schritt weiter und diskutieren, dass Hyperfokus bisher keine einheitliche operationale Definition hat. Was Betroffene als "Hyperfokus" beschreiben, ist heterogen — manchmal angenehm, manchmal gefangen, manchmal beides gleichzeitig.
...
**Flow** wurde von [Mihály Csikszentmihalyi](https://positivepsychology.com/mihaly-csikszentmihalyi-father-of-flow/) als optimaler Zustand zwischen Anforderung und Fähigkeit beschrieben: du bist gefordert, aber nicht überfordert; das Ziel ist klar; du bekommst unmittelbares Feedback; das Tun fühlt sich mühelos an. Flow ist **adaptiv** — am Ende einer Flow-Phase fühlst du dich gestärkt, kompetent, oft sogar erholt.
...
Ein kleines Tool, das hilft: führe eine **Mood-Notiz** *nach* Hyperfokus-Phasen. Über Wochen siehst du das Muster: nach welchen Aktivitäten kommst du gereizt raus, nach welchen rund? Welche Themen ziehen dich in unproduktiven Hyperfokus? Dafür reicht in DopaHop ein [dreifacher Mood-Tipp](/de/) — Stimmung, Energie, ein Tag — kein Tagebuch, das du nicht führen wirst.
...
Wenn dich das Thema interessiert, schau auch hier rein: [ADHS exekutive Funktionen: was wirklich zusammenbricht](/de/blog/adhd-executive-functions-what-breaks/) und [ADHS und Multitasking: Mythos gegen Realität](/de/blog/adhs-multitasking-mythos-gegen-realitaet/) — beide hängen direkt mit dem Aufmerksamkeitssystem zusammen, das hier eine Rolle spielt.
