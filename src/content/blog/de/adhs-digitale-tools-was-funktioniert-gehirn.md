---
title: "ADHS und digitale Tools: was wirklich für dein Gehirn funktioniert"
description: "ADHS und digitale Tools: warum die meisten Task-Manager scheitern, welche Auswahlkriterien zählen und wie du ein minimales Setup baust, das auch an schlechten Tagen trägt."
excerpt: "Du hast schon zehn Apps probiert? Liegt nicht an dir. Liegt am Design."
pubDate: 2026-07-26
updatedDate: 2026-07-26
tags: ["ADHS", "digitale Tools", "Task-Manager", "Produktivität"]
locale: de
draft: false
author: "Nunzio C."
...
Siehe auch: [ADHS Prokrastination: der reale Mechanismus, nicht Faulheit](/de/blog/adhs-prokrastination-realer-mechanismus/) für den Hintergrund, warum "einfach machen" bei ADHS strukturell nicht greift.

## Ein minimales, ehrliches Setup

Wenn du heute neu anfangen würdest, könnte ein realistisches Setup so aussehen:

1. **Ein Eingabe-Ort für alles, was dir spontan einfällt.** Eine schnelle Notiz-App oder ein Brain-Dump-Modul. Niedrige Eintrags-Reibung. Du musst nichts kategorisieren — nur reinschreiben, bevor es weg ist.
2. **Ein Aufgaben-Ort mit sichtbaren Erinnerungen.** Eine App, die *dich* erinnert, nicht eine, die du erinnern musst, dich zu erinnern. Push-Benachrichtigung, Widget, gegebenenfalls Ton.
3. **Ein Kalender für Termine mit anderen Menschen** (Arzttermine, Treffen, Deadlines). Vermische Termine nicht mit Aufgaben — Termine sind unverhandelbar mit der Welt da draußen, Aufgaben sind verhandelbar mit dir selbst.
4. **Maximal ein zusätzliches Modul** für etwas, das dir konkret hilft — etwa Pomodoro-Timer, Mood-Tracker oder Routinen. Kein zweites, kein drittes.
...
Was die App bewusst tut: niedrige Eintrags-Reibung (etwa beim [Brain Dump](/#cosa-fa) — zehn Sekunden, ein Gedanke, raus aus dem Kopf), modulares Onboarding (du aktivierst nur, was du brauchst, siehe [Was die App macht](/#cosa-fa)), Erinnerungen ohne Schuld-Logik (etwa bei [Medikamentenerinnerungen](/#cosa-fa) — wenn du einen Tag auslässt, gibt es keine "Strähne", die reißt), und Daten ausschließlich [auf dem Gerät](/#privacy) (kein Account, kein Server, keine Inhaltsanalyse — DSGVO-konform by design, weil schlicht keine personenbezogenen Daten unser Haus verlassen).
...
Siehe auch: [ADHS exekutive Funktionen: was wirklich zusammenbricht](/de/blog/adhd-executive-functions-what-breaks/), wenn du verstehen willst, warum dein Gehirn beim Planen so oft hängt.
