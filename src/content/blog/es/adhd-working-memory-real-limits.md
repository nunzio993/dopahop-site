---
title: "TDAH y memoria de trabajo: límites reales concretos"
description: "TDAH y memoria de trabajo: qué es de verdad, qué déficits están medidos en adultos, en qué se nota cada día y estrategias para externalizar la carga."
excerpt: "No es mala memoria ni distracción: el espacio mental activo es estructuralmente más pequeño."
pubDate: 2026-06-22
updatedDate: 2026-06-22
tags: ["TDAH", "memoria de trabajo", "funciones ejecutivas", "adultos"]
locale: es
draft: false
author: "Nunzio C."
...
Si te interesa cómo se conecta esto con el cuadro general de funciones ejecutivas, hay un artículo dedicado al tema: [TDAH y funciones ejecutivas: qué se rompe realmente](/es/blog/adhd-executive-functions-what-breaks/).
...
- **Hacer dos cosas a la vez "para optimizar tiempo".** Cada cambio de tarea consume el contenido activo. Si tu espacio mental ya es más pequeño, multitarea es la receta perfecta para perder todo lo que tenías sostenido. Sobre esto hay un artículo entero: [TDAH y multitarea: el mito y lo que cuesta de verdad](/es/blog/adhd-multitasking-myth-vs-reality/).
