...
Y aquí va la primera mención útil: si tu cabeza está lanzando ideas a toda velocidad y sabes que las vas a perder antes de poder anotarlas, [el brain dump de DopaHop](/#cosa-fa) te las captura en diez segundos. No te diagnostica nada — pero te ahorra perder los pensamientos que querrías llevar a la consulta.

## Mitos frecuentes (y por qué duelen)
...
1. **Médico de familia**: primer contacto. Descarta causas médicas básicas (analítica, tiroides, sueño) y deriva.
2. **Centro de Salud Mental (CSM)** del área: aquí te ven psiquiatra, psicólogo clínico o, en algunas comunidades, neuropsicólogo. Aplican entrevistas estructuradas y, a veces, pruebas neuropsicológicas.
3. **Diagnóstico y plan**: incluye psicoeducación, posible terapia (TCC adaptada a TDAH funciona bien), valoración farmacológica si procede, y seguimiento.
