...
En adultos, el DSM-5 baja el umbral a 5 síntomas (en lugar de 6) precisamente porque el cuadro se atenúa en superficie pero el coste funcional persiste. Si quieres el detalle de los 18 síntomas y los criterios completos, lo desglosamos en este artículo: [TDAH y DSM-5: criterios clínicos explicados sin jerga](/es/blog/adhd-dsm-5-criteria/).
...
Si llevas la cabeza llena de pensamientos que vas a perder antes de poder anotarlos, [el brain dump de DopaHop](/#cosa-fa) los captura en diez segundos. No diagnostica nada, pero te ayuda a sostener un registro útil para la consulta — y para tu día a día, cuando la memoria de trabajo no llega.

## Por qué la edad adulta enmascara el TDAH (y por qué eso engaña)
...
Vea también: [TDAH y DSM-5: criterios clínicos explicados sin jerga](/es/blog/adhd-dsm-5-criteria/), donde repasamos los criterios diagnósticos completos y la ruta para pedir cita en el sistema sanitario español.
...
1. **Médico de familia**: descarta causas médicas (analítica, tiroides, sueño), valora derivación.
2. **Centro de Salud Mental** del área: psiquiatra o psicólogo clínico aplica entrevista estructurada, a veces pruebas neuropsicológicas.
3. **Diagnóstico y plan**: psicoeducación, terapia (la TCC adaptada a TDAH funciona bien en adultos), valoración farmacológica si procede.
