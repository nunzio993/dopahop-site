---
title: "TDAH y finanzas: por qué te endeudas y cómo frenarlo"
description: "TDAH y finanzas personales: por qué la impulsividad lleva a deuda, qué dice la ciencia sobre el delay discounting, y estrategias prácticas que sí funcionan."
excerpt: "Si miras la cuenta con miedo y compras para sentirte mejor, no eres irresponsable. Hay un mecanismo."
pubDate: 2026-08-07
updatedDate: 2026-08-07
tags: ["TDAH", "finanzas personales", "impulsividad", "deuda"]
locale: es
draft: false
author: "Nunzio C."
...
Si quieres profundizar en el mecanismo de la decisión rápida, lo desarrollamos en [TDAH y decisiones impulsivas: qué pasa de verdad hoy](/es/blog/adhd-impulsive-decision-making/).
...
- **Finanzas para Todos** ([finanzasparatodos.es](https://www.finanzasparatodos.es)), el plan de educación financiera del Banco de España y la CNMV. Material neutral, sin intereses comerciales detrás.
- **ASUFIN** ([asufin.com](https://www.asufin.com)), asociación de usuarios financieros que ofrece asesoramiento sobre productos bancarios, deudas y reclamaciones.
...
- **[Brain dump](/#cosa-fa)**: cuando te entra el impulso de comprar algo, anótalo en diez segundos en lugar de comprarlo. Se vuelve una lista de "cosas que pensé que necesitaba". Al revisarla a la semana, la mayoría te parecerán absurdas. Es la regla de las 24 horas hecha hábito.
- **[Recordatorios](/#cosa-fa)**: programa la auditoría trimestral de suscripciones y la revisión mensual con tu pareja. La notificación llega aunque tu cerebro la haya borrado.
- **[Mood check-in](/#cosa-fa)**: tres toques antes de comprar para ver en qué estado emocional estás. Si compras desde aburrimiento, ansiedad o frustración, vale la pena saberlo antes de pulsar el botón.

DopaHop guarda todo [en local en tu móvil](/#privacy), sin cuenta y sin servidores: tus datos financieros y tus impulsos no salen de tu teléfono.
