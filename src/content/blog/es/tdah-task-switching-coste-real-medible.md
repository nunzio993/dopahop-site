---
title: "Task switching y TDAH: el coste real, datos medibles"
description: "Task switching cost en TDAH: cuánto tiempo te quita cambiar de tarea, qué dice la ciencia, cómo notarlo y estrategias prácticas para reducirlo de verdad."
excerpt: "Cada salto entre tareas tiene un precio. En el cerebro TDAH ese precio se paga con intereses."
pubDate: 2026-08-26
updatedDate: 2026-08-26
tags: ["TDAH", "task switching", "productividad", "funciones ejecutivas", "coste cognitivo"]
locale: es
draft: false
author: "Nunzio C."
...
- **"Apago todo y trabajo 4 horas seguidas."** Muy bonito en LinkedIn, irrealista para la mayoría de cerebros TDAH. Bloquear bloques larguísimos sin pausas suele acabar en hiperfoco no elegido o en colapso a la hora y media. Ver también: [TDAH y multitarea: el mito y lo que cuesta de verdad](/es/blog/tdah-multitarea-mito-coste-real/).
...
Aquí encaja [el brain dump de DopaHop](/#cosa-fa): diez segundos, fuera lo que tengas en la cabeza, y queda guardado. No estás haciendo gestión avanzada del conocimiento, estás bajando el coste neurológico de volver. Cuando regreses, no tendrás que reconstruir contexto: lo tendrás escrito.
...
Antes de pulsar inicio, escribe en una línea qué vas a hacer ("redactar el primer borrador del email a María, sin enviarlo"). Si tienes [el Pomodoro de DopaHop](/#cosa-fa), el timer arranca solo: tú solo decides qué frase de objetivo va dentro del bloque. Si surge una idea durante el Pomodoro, va al brain dump, no abre otra tarea. Vuelves al objetivo declarado.

Para tareas grandes que no caben en un Pomodoro, el siguiente paso natural es descomponerlas en piezas que sí quepan, sin tener que decidir nada nuevo durante el bloque: ver [TDAH y micro-tasking: descomposición del trabajo](/es/blog/tdah-micro-tasking-descomponer-trabajo/).
