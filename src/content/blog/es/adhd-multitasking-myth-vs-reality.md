---
title: "TDAH y multitarea: el mito y lo que cuesta de verdad"
description: "TDAH y multitarea: por qué hacer varias cosas a la vez no existe a nivel cerebral, qué te cuesta de verdad y cómo reducir el cambio constante de tareas."
excerpt: "La multitarea no existe. Es cambio de tarea con coste, y con TDAH ese coste se dispara."
pubDate: 2026-06-16
...
El término técnico es **task-switching cost** y lo describieron de forma clara Rubinstein, Meyer y Evans en un estudio publicado en 2001 por la *American Psychological Association* ([Rubinstein, Meyer & Evans, 2001](https://psycnet.apa.org/doi/10.1037/0096-1523.27.4.763)). Lo que midieron es sencillo: cuando alternas entre dos tareas, tu rendimiento cae respecto a hacerlas seguidas, una detrás de otra. La APA estimó que el cambio constante de actividad puede llegar a costar hasta un 40% de productividad efectiva.
...
El cambio de tarea depende mucho de las funciones ejecutivas: la memoria de trabajo que sostiene "dónde estaba", el control inhibitorio que apaga el contexto anterior, y la flexibilidad cognitiva que activa el nuevo. Si quieres profundizar en este sistema, está bien explicado en [TDAH y funciones ejecutivas: qué se rompe realmente](/es/blog/adhd-executive-functions-what-breaks/).

En el TDAH estos tres sistemas funcionan con menos margen. El resultado práctico es triple:

1. **El re-enganche tarda más.** Cuando vuelves al Excel después de contestar un mensaje en Teams, no tardas 5 segundos en recordar dónde estabas: tardas 30, a veces más. La memoria de trabajo es más frágil y el contexto se pierde antes.
2. **El contexto anterior no se apaga limpiamente.** Sigues pensando en lo que acabas de leer en Slack mientras intentas concentrarte en la hoja de cálculo. Es ruido cognitivo que consume atención sin que te des cuenta.
3. **Cada salto reduce la dopamina disponible.** El cerebro TDAH ya parte de un sistema dopaminérgico irregular (ver [TDAH procrastinación: el mecanismo real, no pereza](/es/blog/adhd-procrastination-real-mechanism/)). Cada cambio forzado consume recursos motivacionales que ya escasean.
...
Cuando estás concentrado y aparece un pensamiento del tipo "ay, tengo que mandarle a Carlos lo del lunes", lo natural es saltar a Outlook y mandarlo. Es un cambio de tarea innecesario. La alternativa es **anotarlo en dos segundos y volver a lo que estabas**. Para esto sirve el [brain dump de DopaHop](/es/#cosa-fa): lo apuntas en diez segundos, sigues con el Excel, y procesas la nota cuando toque la siguiente ventana de comunicación.
...
Para los tramos de trabajo profundo, una técnica como Pomodoro ayuda a sostener el foco sin saltar; si te cuesta arrancar, prueba [el Pomodoro de DopaHop](/es/#cosa-fa): pulsas iniciar y se ocupa él del tiempo, tú solo te ocupas de la tarea.
...
- **[Brain dump](/es/#cosa-fa)**: para capturar pensamientos sin saltar de tarea. Diez segundos y sigues.
- **[Pomodoro](/es/#cosa-fa)**: bloques de 25 minutos sin tocar el móvil. Pulsas iniciar y va solo.
- **[Focus sounds](/es/#cosa-fa)**: lluvia, lofi, ruido marrón de fondo. Cubre el ruido de oficina y crea una señal sonora estable que ayuda al cerebro a quedarse en una sola tarea más tiempo.
...
*Este artículo es informativo y no sustituye la opinión de un profesional. Para diagnóstico, terapia o emergencias, acude a tu médico de cabecera, al Centro de Salud Mental (CSM) de tu zona o a una asociación como [FEAADAH](https://feaadah.org). En caso de emergencia sanitaria: 112. Si estás pasando un momento difícil, puedes llamar a la línea 024 de atención a la conducta suicida.*
