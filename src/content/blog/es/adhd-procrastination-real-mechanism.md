---
title: "TDAH procrastinación: el mecanismo real, no pereza"
description: "TDAH y procrastinación no son pereza. Te explico el mecanismo neurobiológico real: ceguera temporal, dopamina baja y decisiones que se atascan."
excerpt: "No es pereza. Es un cerebro que no genera el empujón químico para arrancar."
pubDate: 2026-05-19
...
Ver también: [TDAH y funciones ejecutivas: qué se rompe realmente](/es/blog/adhd-executive-functions-what-breaks/).
...
Volkow y colaboradores publicaron en *JAMA* un trabajo influyente que muestra esta alteración del sistema dopaminérgico de recompensa y motivación en adultos con TDAH (Volkow et al., 2009, [PMID 19738093](https://pubmed.ncbi.nlm.nih.gov/19738093/)). Trabajos posteriores y meta-análisis, como el de Cortese sobre neuroimagen en TDAH ([PMID 22983386](https://pubmed.ncbi.nlm.nih.gov/22983386/)), siguen apuntando a anomalías en circuitos fronto-estriatales implicados en motivación y control.
...
Si te cuesta arrancar a menudo, prueba [el Pomodoro de DopaHop](/#cosa-fa): pulsas iniciar y arranca solo, sin configurar nada. Tú solo pones el cuerpo.
...
Ver también: [TDAH dopamina: el modelo neurobiológico explicado](/es/blog/adhd-dopamine-neurobiological-model/).
...
- Como referencia clínica, el TDAH está descrito en el **DSM-5-TR** y en la **Guía de Práctica Clínica sobre el TDAH en niños y adolescentes** (AIAQS, 2010), disponible en [GuíaSalud](https://portal.guiasalud.es/). Aunque está centrada en menores, mucha información de base se mantiene útil.
- A nivel asociativo, la **FEAADAH** (Federación Española de Asociaciones de Ayuda al Déficit de Atención e Hiperactividad) agrupa asociaciones de TDAH por comunidades autónomas y puede ayudarte a encontrar recursos cerca: [feaadah.org](https://www.feaadah.org/).
...
*Este artículo es informativo y no sustituye la opinión de un profesional. Para diagnóstico, tratamiento o emergencias, consulta con un médico, psicólogo o psiquiatra cualificado. En caso de emergencia sanitaria: 112.*
