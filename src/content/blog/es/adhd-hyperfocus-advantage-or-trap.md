---
title: "TDAH e hiperfoco: ¿ventaja real o trampa disfrazada?"
description: "TDAH e hiperfoco: por qué no es un superpoder, en qué se diferencia del flow, las señales de hiperfoco tóxico y cómo gestionarlo sin colapsar después."
excerpt: "El hiperfoco no es un superpoder. Es atención atascada, y a veces te deja seco."
pubDate: 2026-06-18
...
La definición operativa más usada en investigación describe el hiperfoco como un estado de **atención sostenida e intensa hacia una sola actividad, con reducción de la conciencia de estímulos externos y del paso del tiempo**, durante el cual otras necesidades (comer, beber, ir al baño, responder mensajes) se posponen o ignoran. La revisión de Ashinoff y Abu-Akel ([2021, *Psychological Research*](https://link.springer.com/article/10.1007/s00426-019-01245-8)) puso orden en una literatura confusa y dejó claro algo importante: el hiperfoco no es una habilidad voluntaria que la persona TDAH activa cuando le interesa algo, sino una **atención sostenida paradójica que el sistema atencional no logra desenganchar**, en la que la atención se "atasca" en un objeto y cuesta soltarla.
...
Ozel-Kizil y colaboradores ([2016, *Research in Developmental Disabilities*](https://pubmed.ncbi.nlm.nih.gov/27681531/)) desarrollaron una escala para medir hiperfoco en adultos con TDAH y validaron una idea que mucha gente sospechaba en la consulta: el hiperfoco correlaciona con TDAH, pero también con interferencia funcional. Es decir, no es solo "intenso", es **interfiere con tu vida** en proporción a su intensidad.
...
Hay un solapamiento importante con el [TDAH y el rendimiento laboral discontinuo](/es/blog/adhd-work-discontinuous-performance/): muchos picos de productividad espectaculares vienen de un hiperfoco no gestionado, seguido de días o semanas de "no puedo más", y este patrón es lo que más confunde a jefes y compañeros.

## Por qué el cerebro TDAH se atasca así

La explicación más coherente con la evidencia conecta el hiperfoco con la [hipótesis dopaminérgica del TDAH](/es/blog/adhd-dopamine-neurobiological-model/) y con un fallo en los sistemas de **cambio atencional** (set-shifting), parte del paquete de funciones ejecutivas. Simplificando bastante:
...
Esto cuadra con lo que describe el artículo de [funciones ejecutivas en el TDAH](/es/blog/adhd-executive-functions-what-breaks/): no es que falte fuerza de voluntad, es que falla la regulación, en ambas direcciones — para arrancar tareas aburridas y para detener tareas estimulantes.
...
Si te cuesta arrancar las alarmas o te las saltas siempre, [el Pomodoro de DopaHop](/es/#cosa-fa) puede servir como entrenador suave: cuando termina, hay un cambio claro, no una notificación que ignoras.
...
No hay un tratamiento específico para el hiperfoco como síntoma aislado. Algunas personas refieren que la medicación para el TDAH (cuando está indicada y pautada por especialista) reduce tanto la dispersión como el atascamiento extremo, mejorando el cambio atencional. Esto es individual y conviene hablarlo con tu médico de cabecera y, si es el caso, con un psiquiatra del Centro de Salud Mental o de FEAADAH ([feaadah.org](https://feaadah.org)).
