---
title: "TDAH y estimulantes: qué hacen realmente (y qué no)"
description: "Metilfenidato y lisdexanfetamina en el TDAH: qué efectos reales tienen, qué mitos hay que descartar, y por qué la decisión es siempre médica. Con cautela."
excerpt: "Ni pastillas de felicidad ni cocaína legal. Lo que de verdad hacen los estimulantes en el TDAH."
pubDate: 2026-07-18
...
1. **Sospecha**: tú, tu familia, tu médico de cabecera o tu psicólogo identificáis un patrón compatible.
2. **Derivación al especialista**: el médico de Atención Primaria deriva al psiquiatra (adultos) o al paidopsiquiatra/neuropediatra (niños y adolescentes).
3. **Evaluación diagnóstica**: entrevistas clínicas, escalas validadas, valoración del historial. El diagnóstico de TDAH es clínico, no se hace con una analítica.
4. **Decisión de tratamiento**: si procede, se valoran opciones farmacológicas y no farmacológicas. Los estimulantes no son obligatorios; son una herramienta más, junto a psicoterapia, psicoeducación y adaptaciones.
5. **Inicio y titulación**: si se opta por estimulante, se empieza con la formulación y la pauta que el psiquiatra considere y se va ajustando con revisiones cercanas.
6. **Receta médica con visado de inspección**: en la farmacia, dispensación con control específico.
7. **Seguimiento**: revisiones periódicas, control de eficacia, efectos secundarios, peso, tensión y frecuencia cardiaca.
...
- **[Recordatorios de medicación](/#cosa-fa)**: notificación a la hora exacta con tres botones (Tomada, En 10 minutos, Saltada). Nada de cadenas que se "rompen" si fallas un día. Hop te espera.
- **[Mood check-in](/#cosa-fa)**: tres toques para registrar cómo estás. Útil para llevar a la consulta del psiquiatra patrones reales, no el "creo que más o menos bien" del día de la cita.
