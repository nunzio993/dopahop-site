---
title: "TDAH sustancias: riesgo y patrones que conviene conocer"
description: "TDAH y uso de sustancias: por qué el riesgo de adicción es mayor, qué patrones son frecuentes, y dónde pedir ayuda en España. Sin moralismos, con fuentes."
excerpt: "Si te reconoces, no eres débil ni vicioso. Hay un mecanismo neurobiológico detrás."
pubDate: 2026-05-31
...
El metaanálisis de Lee y colaboradores ([2011, PMID 21382538](https://pubmed.ncbi.nlm.nih.gov/21382538/)) reunió los datos de varios estudios longitudinales y mostró que los niños con TDAH tienen significativamente mayor probabilidad de desarrollar dependencia o abuso de sustancias en la edad adulta, comparados con sus pares sin TDAH. La revisión posterior de Humphreys ([2013, PMID 23754458](https://pubmed.ncbi.nlm.nih.gov/23754458/)) matizó la cifra y aportó un dato relevante: el tratamiento estimulante en la infancia **no aumenta** el riesgo de adicciones futuras, al contrario de lo que durante años se temió en algunas familias y profesionales.
...
- **Teléfono de Información sobre Adicciones de la Fundación FAD Juventud: 900 161 515** (gratuito, anónimo, lunes-viernes 9-21h). Útil cuando no sabes a qué puerta llamar. Si buscas información institucional, el **Plan Nacional sobre Drogas** ([pnsd.sanidad.gob.es](https://pnsd.sanidad.gob.es)) es el organismo público de referencia.
...
- [Brain dump](/#cosa-fa) para soltar los pensamientos que dan vueltas a las once de la noche, antes de recurrir al porro o a la copa para apagarlos.
- [Mood check-in](/#cosa-fa) en tres toques: te ayuda a notar el patrón "qué emoción aparece justo antes de querer beber/fumar", que es el primer paso de cualquier intervención conductual.
- [Focus sounds](/#cosa-fa) (lluvia, lofi, brown noise) para bajar revoluciones al final del día sin necesidad de alcohol.

Si llevas tiempo dándole vueltas, lee también [TDAH y desregulación emocional: por qué llega tan fuerte](/blog/adhd-emotional-dysregulation/) y [TDAH gaming redes sociales: por qué engancha tanto](/blog/adhd-behavioral-addictions-gaming/): los tres temas se solapan más de lo que parece.
