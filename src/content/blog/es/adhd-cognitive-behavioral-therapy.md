---
title: "TDAH y TCC: qué hace y qué no la terapia cognitivo-conductual"
description: "TDAH y terapia cognitivo-conductual: qué trabaja realmente la TCC adaptada a adultos, por qué no es solo hablar, y cómo encaja con o sin medicación."
excerpt: "No te enseña a tener fuerza de voluntad. Te enseña a no creerte cada cosa que tu cabeza dice."
pubDate: 2026-07-22
updatedDate: 2026-07-22
tags: ["TDAH", "TCC", "terapia cognitivo-conductual", "psicoterapia"]
locale: es
draft: false
author: "Nunzio C."
...
Aquí se solapa fuerte con el trabajo sobre autoestima y con la regulación emocional, dos áreas donde el TDAH adulto suele acumular mucho desgaste. Ver también: [TDAH autoestima: por qué se rompe y cómo reconstruirla](/es/blog/adhd-self-esteem-construction-distortions/) y [TDAH desregulación emocional: por qué llega tan fuerte](/es/blog/adhd-emotional-dysregulation/).
...
- **[Brain dump](/#cosa-fa)**: para soltar en diez segundos el pensamiento que te asalta a media tarde y no perderlo hasta la próxima sesión, sin tener que abrir un diario.
- **[Routine](/#cosa-fa)**: para construir las pequeñas secuencias diarias que tu terapeuta te ayuda a montar, paso a paso, sin que tengas que recordarlas tú.
- **[Mood check-in](/#cosa-fa)**: tres toques al día para registrar cómo estás. Trae datos concretos a la sesión en lugar de "no sé, regular".
- **[Promemoria farmaci](/#cosa-fa)**: si tu pauta incluye medicación, aviso a la hora exacta con tres botones en la notificación, sin lazos de culpa si te saltas una toma.
