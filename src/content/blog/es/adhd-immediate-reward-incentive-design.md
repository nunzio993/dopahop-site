---
title: "TDAH y recompensa inmediata: incentivos que funcionan"
description: "TDAH y recompensa inmediata: por qué tu cerebro descuenta lo lejano, cómo diseñar incentivos que sí encajan y qué errores típicos vacían el sistema."
excerpt: "No te falta voluntad: te falta una recompensa que llegue antes de que el cerebro se vaya."
pubDate: 2026-08-30
updatedDate: 2026-08-30
tags: ["TDAH", "recompensa", "dopamina", "incentivos", "motivación"]
locale: es
draft: false
author: "Nunzio C."
...
Si quieres el detalle del circuito dopaminérgico detrás de esto, ya lo desarrollé en [TDAH dopamina: el modelo neurobiológico explicado](/es/blog/adhd-dopamine-neurobiological-model/).
...
Si las tareas son demasiado grandes para que ningún incentivo enganche, el problema previo es de tamaño, no de motivación: lo desarrollo en [TDAH y micro-tasking: descomponer el trabajo de verdad](/es/blog/adhd-micro-tasking-work-decomposition/).
...
- **[Pomodoro](/#cosa-fa)**: 25 minutos de foco + 5 de pausa. La pausa es la micro-recompensa concreta. No es premio "si haces bien", es ritmo. Pulsas arrancar y empieza solo.
- **[Brain dump](/#cosa-fa)**: diez segundos para sacar un pensamiento que se iba a perder. La recompensa es el alivio instantáneo de "ya no lo tengo que sostener en la cabeza".
- **[Hop](/#cosa-fa)**: el conejo crece contigo, sin rachas, sin culpa. Si vuelves después de tres semanas en blanco, te espera igual. La recompensa no se rompe.
- **[Sonidos de enfoque](/#cosa-fa)**: lluvia, lofi, brown noise. Recompensa auditiva continua mientras trabajas — encaja con el principio "recompensa dentro del gesto, no al final".
...
*Herramientas amables, sin gurús de la productividad.* DopaHop es gratis en Google Play, y Hop te espera siempre — también si vuelves después de una semana floja.

---

*Este artículo es informativo y no sustituye la opinión de un profesional sanitario. Para diagnóstico, terapia o emergencias, acude a un médico, psicólogo o psiquiatra cualificado. En España puedes empezar por tu médico de cabecera, que te derivará al Centro de Salud Mental (CSM) o al especialista correspondiente; FEAADAH ([feaadah.org](https://www.feaadah.org)) ofrece orientación asociativa. En caso de emergencia sanitaria: 112.*
