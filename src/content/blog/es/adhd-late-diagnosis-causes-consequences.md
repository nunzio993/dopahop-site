---
title: "Diagnóstico tardío TDAH: por qué ocurre y qué consecuencias tiene"
description: "Diagnóstico tardío de TDAH en adultos: por qué pasa desapercibido durante años, qué consecuencias deja el camino sin diagnosticar y cómo orientarse después."
excerpt: "Llegar tarde al diagnóstico no es culpa tuya. Pero entender por qué pasó cambia mucho lo que viene después."
pubDate: 2026-05-13
...
En España la puerta de entrada habitual es el médico de cabecera, que deriva al Centro de Salud Mental, donde un psiquiatra o un psicólogo clínico hace la valoración. La [FEAADAH](https://www.feaadah.org/) agrupa más de 70 asociaciones en España y ofrece información sobre TDAH a familias, profesionales y personas adultas afectadas.

Ver también: [TDAH infantil vs adulto: cómo cambia la misma condición](/es/blog/adhd-children-vs-adults/).
...
Ninguna de estas cosas es "culpa" de la persona. Son lo que ocurre cuando un cerebro funciona de una manera y el entorno asume que funciona de otra. La [Guía de Práctica Clínica sobre el TDAH del Ministerio de Sanidad](https://portal.guiasalud.es/) recoge buena parte de este perfil de impacto a largo plazo.
...
Si te cuesta arrancar las tareas, [el pomodoro de DopaHop](/#cosa-fa) puede ayudarte: pulsas iniciar y el temporizador arranca solo, tú solo piensas en hacer.

## Cómo orientarse en España si sospechas TDAH no diagnosticado
...
5. **Información de partida.** Web de [FEAADAH](https://www.feaadah.org/) y la [Guía de Práctica Clínica del Ministerio de Sanidad](https://portal.guiasalud.es/).
...
*Herramientas suaves, no gurús de la productividad.* DopaHop es gratis en Google Play, y Hop te espera siempre, también después de semanas difíciles.
