---
title: "TDAH dysrégulation émotionnelle : émotions fortes et rapides"
description: "TDAH et dysrégulation émotionnelle : pourquoi les émotions arrivent fort et vite, ce que dit le DSM-5-TR, et des stratégies concrètes qui tiennent."
excerpt: "Émotions qui débordent en trois secondes ? Ce n'est pas un défaut de caractère, c'est ton TDAH."
pubDate: 2026-05-22
updatedDate: 2026-05-22
tags: ["TDAH", "émotions", "dysrégulation", "neuroatypie"]
locale: fr
draft: false
author: "Nunzio C."
...
1. **Spécificité** : les émotions intenses se retrouvent aussi dans le trouble bipolaire, le trouble borderline, l'anxiété, la dépression. Inclure la dysrégulation émotionnelle comme critère TDAH compliquerait le diagnostic différentiel.
2. **Histoire diagnostique** : le TDAH a été défini historiquement autour de l'attention et de l'hyperactivité. Élargir aux émotions modifie le périmètre du trouble.
3. **Recherche en cours** : la communauté scientifique reconnaît de plus en plus la centralité de la dysrégulation émotionnelle (voir [Soler-Gutiérrez et al., PLOS One 2023](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0280131) sur la prévalence de la DESR chez l'adulte TDAH), mais le consensus pour la promouvoir au rang de critère core n'est pas encore là.
...
Voir aussi : [TDAH selon le DSM-5 : critères et définition opérationnelle](/fr/blog/adhd-dsm-5-criteria/) pour comprendre comment lire les critères officiels sans s'y enfermer.
...
Voir aussi : [TDAH fonctions exécutives : ce qui casse vraiment](/fr/blog/adhd-executive-functions-what-breaks/) pour comprendre comment le frein préfrontal s'épuise.
...
C'est un usage classique d'un mood tracker. Trois tapotements par jour — comment tu vas, ton énergie, un mot-clé — suffisent pour repérer le pattern. Le [mood check-in de DopaHop](/#cosa-fa) est conçu pour ça : pas un journal intime, juste un point rapide qui te dessine une carte sur deux semaines.
...
alors ce n'est plus juste un ajustement de stratégies — c'est le moment de parler à ton médecin traitant pour une orientation vers un psychiatre ou un CMP. HyperSupers TDAH France ([tdah-france.fr](https://www.tdah-france.fr/)) liste des praticiens et propose un soutien associatif. En cas de crise, le 15 (SAMU) ou le 112.
