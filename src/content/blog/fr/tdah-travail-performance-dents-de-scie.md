---
title: "TDAH travail : la performance en dents de scie"
description: "TDAH au travail : pourquoi la performance varie autant d'un jour à l'autre, comment gérer, et les aménagements raisonnables qui aident vraiment."
excerpt: "Lundi tu abats le double, jeudi tu rames sur un mail. Ce n'est pas toi : c'est ton TDAH au travail."
pubDate: 2026-06-12
...
Voir aussi : [TDAH fonctions exécutives : ce qui casse vraiment](/fr/blog/adhd-executive-functions-what-breaks/) pour comprendre ce qui rame en arrière-plan quand le démarrage ne vient pas.
...
Voir aussi : [TDAH et sommeil : pourquoi le rythme circadien décale](/fr/blog/tdah-sommeil-rythmes-circadiens-decales/) si la fatigue s'invite régulièrement dans tes pics et tes creux.
...
C'est exactement le rôle du [brain dump de DopaHop](/#cosa-fa) : en dix secondes tu fixes la pensée, puis tu reviens à ce que tu faisais sans avoir cassé ton fil. Tu retraites la liste plus tard, quand tu as la disponibilité mentale.
...
- **[Brain dump](/#cosa-fa)** : pour vider la file d'attente mentale en dix secondes pendant que tu travailles, sans casser ton fil.
- **[Pomodoro](/#cosa-fa)** : 25 minutes de focus, 5 de pause. Tu appuies, ça démarre. Pas de paramétrage, pas de friction.
- **[Mood check-in](/#cosa-fa)** : trois tap pour suivre humeur et énergie. Sur deux semaines, tu vois apparaître ta vraie courbe — et tu peux enfin construire ton agenda autour, pas contre.
