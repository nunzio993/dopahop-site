---
title: "TDAH et multitâche : mythe vs réalité"
description: "TDAH et multitâche : pourquoi le cerveau ne fait jamais deux choses en parallèle, pourquoi le coût est plus élevé en TDAH, et comment réduire le switching."
excerpt: "Le multitâche n'existe pas. Ce que tu fais, c'est sauter d'une tâche à l'autre — et ça coûte cher."
pubDate: 2026-06-16
updatedDate: 2026-06-16
tags: ["TDAH", "multitâche", "productivité", "fonctions exécutives"]
locale: fr
draft: false
author: "DopaHop"
...
Le switching mobilise trois fonctions exécutives directement : l'inhibition (pour ignorer la tâche précédente), la mémoire de travail (pour garder en tête où tu en étais), et la flexibilité cognitive (pour basculer le cadre mental). Ce sont précisément les trois fonctions qui fonctionnent avec un rendement inférieur dans le TDAH adulte. Pour comprendre lesquelles cassent et comment, voir [TDAH fonctions exécutives : ce qui casse vraiment](/fr/blog/adhd-executive-functions-what-breaks/).
...
Si tu n'arrives pas à démarrer un bloc seul, [le Pomodoro de DopaHop](/fr/) te lance le timer en un tap — tu n'as plus à décider quand et comment commencer, juste à appuyer.
...
C'est lié de très près à la procrastination — le détail du mécanisme est ici : [TDAH procrastination : le mécanisme réel](/fr/blog/adhd-procrastination-real-mechanism/).
...
L'association HyperSupers TDAH France ([tdah-france.fr](https://www.tdah-france.fr)) recense des consultations spécialisées par région. La Haute Autorité de Santé (HAS) a également publié un cadre de référence sur le TDAH adulte, qui peut t'aider à préparer un rendez-vous avec ton médecin traitant.
