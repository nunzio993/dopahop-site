---
title: "Récompense immédiate TDAH : concevoir des incitations qui marchent"
description: "TDAH et récompense immédiate : pourquoi ton cerveau préfère le petit gain tout de suite, et comment concevoir des incitations qui collent vraiment à cette logique."
excerpt: "Promettre une récompense « dans une semaine » ne marche pas. Voici pourquoi, et ce qui marche à la place."
pubDate: 2026-08-30
updatedDate: 2026-08-30
tags: ["TDAH", "récompense", "dopamine", "incitations", "motivation"]
locale: fr
draft: false
author: "Nunzio C."
...
- **[Le Pomodoro](/#cosa-fa)** : tu appuies, le compte à rebours démarre, le retour visuel est continu. Tu n'as pas à décider quand t'arrêter ni quand reprendre.
- **[Le brain dump](/#cosa-fa)** : dix secondes pour vider une pensée hors de ta tête. La récompense immédiate, c'est de ne plus avoir cette idée en train de tourner pendant que tu travailles.
- **[Les focus sounds](/#cosa-fa)** : pluie, lofi, brown noise — un cadre sonore qui devient le signal « je suis dans la tâche ». La récompense est dans le contexte sonore lui-même, pas après.
- **[Hop, la mascotte](/#perche)** : un compagnon qui grandit avec toi, sans streak, sans culpabilité. Si tu sautes une semaine, Hop t'attend. La récompense est de te retrouver, pas de tenir une chaîne.
...
Si ce sujet te parle, ces articles creusent les pièces voisines du puzzle :

- [TDAH dopamine : le modèle neurobiologique expliqué](/fr/blog/adhd-dopamine-neurobiological-model/) — pour comprendre ce qui se passe en amont, dans le circuit lui-même.
- [TDAH procrastination : le mécanisme réel, pas la flemme](/fr/blog/adhd-procrastination-real-mechanism/) — pour relier la récompense immédiate au problème de démarrage.
- [TDAH et micro-tasking : décomposer le travail en pas concrets](/fr/blog/adhd-micro-tasking-work-decomposition/) — pour appliquer la logique « pas qui coche tout seul » à des projets plus complexes.
