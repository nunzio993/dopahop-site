---
title: "TDAH fonctions exécutives : ce qui casse vraiment"
description: "TDAH et fonctions exécutives : ce qui se casse concrètement, pourquoi ce n'est pas un manque de volonté, et quelles stratégies tiennent dans le temps."
excerpt: "Pas de volonté en panne : un système de pilotage qui rame. Voici lesquels rouages cassent vraiment."
pubDate: 2026-05-07
...
Voir aussi : [TDAH selon le DSM-5 : critères et définition opérationnelle](/fr/blog/adhd-dsm-5-criteria/) pour comprendre comment ces dysfonctions s'inscrivent dans les critères diagnostiques officiels.
...
C'est exactement le rôle d'un [brain dump](/#cosa-fa) : en dix secondes tu balances la pensée, elle est sauvegardée, ton cerveau peut lâcher prise. Tu la retraites quand tu en as l'énergie.
...
- **[Brain dump](/#cosa-fa)** : pour externaliser ta mémoire de travail. Une pensée arrive, dix secondes, elle est mise au sec. Tu reviens dessus quand tu veux.
- **[Pomodoro](/#cosa-fa)** : pour rendre le temps visible et réduire l'initiation à un geste. Tu appuies, le timer part, tu n'as plus à te demander quand t'arrêter.
- **[Spacca-task](/#cosa-fa)** : pour quand une tâche est trop grosse. Un assistant te guide pour la découper en cinq étapes concrètes — parce que découper *quand on est déjà coincé* demande exactement la fonction qui rame.
