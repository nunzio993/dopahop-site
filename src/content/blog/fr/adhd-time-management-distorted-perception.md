---
title: "TDAH et gestion du temps : la perception déformée"
description: "TDAH et gestion du temps : pourquoi la perception du temps est faussée (time blindness), ce qui se passe dans le cerveau, et ce qui aide au quotidien."
excerpt: "Tu n'es pas en retard par flemme. Ton cerveau ne perçoit pas le temps comme les autres."
pubDate: 2026-06-20
updatedDate: 2026-06-20
tags: ["TDAH", "time blindness", "gestion du temps", "fonctions exécutives"]
locale: fr
draft: false
author: "Nunzio C."
...
Pour aller plus loin sur le système exécutif sous-jacent, voir [TDAH fonctions exécutives : ce qui casse vraiment](/fr/blog/adhd-executive-functions-what-breaks/).
...
Si le démarrage coince justement parce que tu ne sens pas le temps, [le Pomodoro de DopaHop](/#cosa-fa) est conçu exactement pour ça : tu lances, le timer tourne tout seul, et tu vois la progression visuellement.
...
Quand tu travailles et qu'une pensée parasite déclenche un *switch* ("ah il faut que je rappelle X, et aussi commander Y..."), elle vole de la mémoire de travail — donc casse encore plus ta perception du temps en cours. Avoir un endroit unique où poser ces pensées en deux secondes permet de les sortir de la tête sans rompre le flux. Le [brain dump de DopaHop](/#cosa-fa) sert exactement à ça : tu jettes la pensée en dix secondes, tu y reviens plus tard, tu reprends ce que tu faisais.
