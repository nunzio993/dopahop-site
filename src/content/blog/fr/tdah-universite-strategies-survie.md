---
title: "TDAH et université : stratégies réelles de survie"
description: "TDAH et université : pourquoi les études supérieures sont un terrain piégé, ce que la fac ne te dit pas, et des stratégies concrètes qui tiennent vraiment."
excerpt: "Partiels, mémoire, ECTS qui s'accumulent : la fac n'a pas été pensée pour ton cerveau. Voici ce qui aide vraiment."
pubDate: 2026-06-14
...
Si tu veux comprendre plus précisément ce qui se passe côté fonctions exécutives, jette un œil à [TDAH fonctions exécutives : ce qui casse vraiment](/fr/blog/adhd-executive-functions-what-breaks/) — ça donne le vocabulaire pour mettre des mots sur ce que tu vis pendant les révisions.
...
1. **Tu prends rendez-vous avec le SSE** (Service de Santé Étudiante, anciennement SUMPPS, depuis le décret n° 2023-178 du 13 mars 2023) ou avec la **Mission Handicap** de ton université. Les noms varient (Pôle Handicap, Relais Handicap, Cellule Handicap), la fonction est la même.
2. **Tu apportes ton diagnostic** : courrier de psychiatre, neuropsy, ou bilan neurodéveloppemental. Plus c'est récent et détaillé, mieux c'est.
3. **Le médecin du SSE rédige un avis médical** sur les aménagements adaptés à ta situation.
4. **L'avis est transmis à la commission** de l'université qui valide les aménagements pour la durée du cursus (souvent annuel à reformuler).
...
Si démarrer est ton point de friction principal, [le Pomodoro de DopaHop](/#cosa-fa) est conçu pour ça : tu appuies sur démarrer, le minuteur part tout seul, tu n'as plus à décider. Pas de streak à entretenir, pas de message culpabilisant si tu sautes une session.
...
Pour les enjeux plus larges qui s'enchevêtrent souvent avec les études — anxiété persistante, ruminations, panique avant les partiels — l'article [TDAH anxiété : comorbidité et confusion diagnostique](/fr/blog/tdah-anxiete-comorbidite-confusion-diagnostique/) creuse spécifiquement le sujet et peut t'aider à mettre des mots sur ce que tu traverses.
