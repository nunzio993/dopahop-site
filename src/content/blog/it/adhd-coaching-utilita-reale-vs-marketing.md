---
title: "ADHD e coaching: utilità reale vs marketing aggressivo"
description: "ADHD e coaching: cosa funziona davvero, come distinguere il coaching serio dai guru, costi, regolamentazione italiana e limiti rispetto alla terapia."
excerpt: "Non tutti i coach ADHD sono uguali. Ecco come distinguere quello serio da quello da Instagram."
pubDate: 2026-07-24
updatedDate: 2026-07-24
tags: ["ADHD", "coaching", "supporto", "produttività"]
locale: it
draft: false
author: "Nunzio C."
...
Vedi anche: [ADHD e CBT: cosa funziona davvero negli adulti](/blog/adhd-cbt-cosa-funziona-adulti/) per capire la differenza tra coaching e psicoterapia evidence-based per l'ADHD.
...
In Italia, la diagnosi di ADHD adulto si ottiene partendo dal medico di base che, valutato il quadro, ti indirizza a uno specialista (psichiatra, neuropsichiatra, neurologo). Il percorso pubblico passa attraverso CSM (Centri di Salute Mentale) territoriali, ASL e — soprattutto — centri di riferimento accreditati (Registro Nazionale ADHD AIFA), spesso con liste d'attesa lunghe e distribuzione disomogenea sul territorio. Vedi anche: [ADHD diagnosi tardiva: cause e conseguenze nell'adulto](/blog/adhd-late-diagnosis-causes-consequences/) per capire meglio il percorso diagnostico.

## DopaHop e coaching: due cose diverse, da non confondere

Una nota importante, perché serve chiarezza. **DopaHop non è coaching.** DopaHop è uno strumento operativo — un'app — che ti aiuta nel quotidiano con micro-operazioni concrete: ricordarti i farmaci senza assillarti, decomporre un task troppo grande in passi più piccoli, buttare fuori un pensiero prima che svanisca con il [brain dump](/#cosa-fa), avere un timer Pomodoro che parte da solo. Non è un coach umano, non sostituisce un coach umano, e non sostituisce neppure la terapia.
...
Se ti capita spesso di partire entusiasta con un nuovo "metodo" e crollare dopo due settimane, prima di pagare un coach prova [il Pomodoro di DopaHop](/#cosa-fa) e i [focus sounds](/#cosa-fa) — sono gratis, nessuno ti chiede niente, e ti danno un'idea concreta di come funzioni con un supporto operativo prima di investire centinaia di euro.
