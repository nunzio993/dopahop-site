---
title: "ADHD e mascheramento: il costo nascosto del 'sembrare normale'"
description: "ADHD e mascheramento sociale: cos'è il masking, perché esaurisce, come distinguerlo dal coping sano e quando è sicuro abbassare la maschera."
excerpt: "Sembrare 'a posto' tutto il giorno è un secondo lavoro che nessuno ti paga."
pubDate: 2026-08-15
updatedDate: 2026-08-15
tags: ["ADHD", "mascheramento", "identità", "salute mentale"]
locale: it
draft: false
author: "Nunzio C."
translationKey: "adhd-social-masking"
---
...
| Coping adattivo | Mascheramento |
|---|---|
| Usi una checklist per non dimenticare | Nascondi che usi la checklist perché "fa scena male" |
| Scrivi le idee nel telefono per non perderle | Fingi che le tue idee siano "venute lì sul momento" |
| Chiedi un riepilogo scritto dopo una riunione | Annuisci come se avessi seguito tutto |
| Lavori meglio con cuffie e brown noise | Le togli appena entra qualcuno per non sembrare "strano" |
| Spieghi ai colleghi che hai bisogno di pause | Resti immobile alla scrivania accumulando tensione |
...
- **[Brain dump](/#cosa-fa)**: butti fuori in dieci secondi i pensieri che stai trattenendo per "non sembrare disorganizzato". Li rivedi quando hai energia, senza doverli memorizzare a forza in pubblico.
- **[Mood check-in](/#cosa-fa)**: tre tap per registrare come stai davvero, anche quando fuori sorridi. Un grafico settimanale ti aiuta a vedere il costo accumulato del masking prima che diventi crollo.
- **[Hop](/#perche)**: niente streak, niente colpa. Se per una settimana hai dovuto mascherare a oltranza e l'app la apri solo il sabato, Hop è ancora lì. Una zona piccola dove non devi performare nulla.
