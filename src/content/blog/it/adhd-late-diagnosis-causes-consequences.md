---
title: "Diagnosi tardiva ADHD: perché succede e che effetti ha"
description: "Diagnosi tardiva ADHD negli adulti: perché tanti arrivano in ritardo, cosa succede al lavoro e nelle relazioni, e come muoversi nel sistema sanitario italiano."
excerpt: "Arrivare alla diagnosi a 35 o 50 anni non è un fallimento: è il pezzo che mancava per leggersi diversamente."
pubDate: 2026-05-13
...
L'Istituto Superiore di Sanità ([epicentro.iss.it/deficit-attenzione/](https://www.epicentro.iss.it/deficit-attenzione/)) inquadra l'ADHD come un disturbo del neurosviluppo. La letteratura clinica internazionale e i percorsi italiani per l'adulto attivati negli ultimi anni convergono sul fatto che, in una quota significativa di casi, il disturbo persiste in età adulta. Le linee guida SINPIA per l'età evolutiva e i Centri di Riferimento per ADHD adulto convergono sullo stesso punto: l'ADHD non scompare a diciotto anni, cambia forma.
...
- **Presentazione inattentiva poco visibile.** Chi ha la presentazione prevalentemente disattenta tende a essere considerato "lento", "nelle nuvole", "pigro" più che ADHD. *Vedi anche: [ADHD inattentivo vs iperattivo: differenze reali](/blog/adhd-inattentive-vs-hyperactive/).*
...
*Vedi anche: [ADHD nei bambini e negli adulti: cosa cambia davvero](/blog/adhd-children-vs-adults/).*
...
1. **Parla con il medico di base.** È la porta d'ingresso al servizio sanitario nazionale. Spiega il sospetto, porta esempi concreti (non sintomi astratti: "perdo le chiavi quattro volte al giorno", "non ricordo di aver mangiato"). Chiedi un'impegnativa per una valutazione specialistica.
2. **Centro di Salute Mentale (CSM) territoriale.** È il riferimento pubblico per la salute mentale dell'adulto. Non tutti i CSM hanno un percorso ADHD adulto strutturato, ma tutti possono indirizzarti.
3. **Centri di Riferimento per ADHD adulto.** In Italia esistono ambulatori dedicati in alcuni ospedali e università. Le associazioni di pazienti — in particolare AIDAI ([aidaiassociazione.com](https://www.aidaiassociazione.com/)) — mantengono elenchi aggiornati e possono orientarti su quello più vicino.
4. **Valutazione privata.** Se i tempi pubblici sono lunghi (e spesso lo sono), molti adulti scelgono una valutazione privata da psichiatra o psicologo specializzato in ADHD adulto. Verifica sempre la formazione specifica sull'ADHD: non tutti gli specialisti la hanno.
5. **Dopo la diagnosi.** Il piano può includere psicoeducazione, terapia (cognitivo-comportamentale per ADHD), eventualmente farmaci, e adattamenti pratici. La gestione è multimodale, non solo farmacologica.
...
DopaHop è uno strumento gentile pensato anche per questa fase: prova [il brain dump](/#cosa-fa) per buttare fuori i pensieri che si affollano dopo una diagnosi senza dover decidere subito cosa farne — li rivedi quando sei pronto. Hop ti aspetta anche se torni dopo settimane.
