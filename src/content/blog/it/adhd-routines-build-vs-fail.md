---
title: "ADHD e routine: perché crollano e come costruirle bene"
description: "ADHD e routine: perché falliscono quasi sempre (over-engineering, perfezionismo, no anchor cue), come costruirne una minimale che regge le giornate storte."
excerpt: "Le routine ADHD crollano per progettazione sbagliata, non per mancanza di volontà. Ecco cosa cambiare."
pubDate: 2026-07-28
updatedDate: 2026-07-28
tags: ["ADHD", "routine", "abitudini", "produttività"]
locale: it
draft: false
author: "Nunzio C."
...
Allo stesso tempo, costruire una routine richiede esattamente quello che nell'ADHD è ridotto: pianificazione, working memory, inibizione delle distrazioni, regolazione dell'attenzione. La meta-analisi di [Willcutt e colleghi (2005)](https://pubmed.ncbi.nlm.nih.gov/15950006/) su 83 studi mostra che le persone con ADHD hanno effect size moderati (0.46-0.69) in compiti di response inhibition, working memory e planning — esattamente i mattoni di qualsiasi routine.
...
Vedi anche: [Funzioni esecutive ADHD: cosa si rompe davvero in pratica](/blog/adhd-executive-functions-what-breaks/) per capire meglio quali sistemi cognitivi sono coinvolti.
...
Se ti riconosci nella spirale "salto un giorno → mi sento in colpa → salto la settimana → abbandono", prova [le routine di DopaHop](/#cosa-fa) — trascini i passi nell'ordine che vuoi, premi Avvia e l'app ti accompagna uno alla volta. Niente streak, niente catena da non rompere: se salti, riparti senza che nessuno ti dica niente.
...
Vedi anche: [ADHD procrastinazione: meccanismo reale, non pigrizia](/blog/adhd-procrastination-real-mechanism/) per capire meglio perché "basta volerlo" non è una strategia.
...
- **[ISS](https://www.iss.it/)** (Istituto Superiore di Sanità): informazioni istituzionali su ADHD e neurosviluppo.
- **[AIDAI](https://www.aidaiassociazione.com/)**: associazione italiana per i disturbi di attenzione e iperattività, con materiale per adulti e indicazioni cliniche.
...
*Questo articolo è informativo e non sostituisce il parere di un professionista. Per diagnosi, terapia o emergenze, rivolgiti a un medico, psicologo o psichiatra qualificato. In caso di emergenza: 112 (Numero Unico Europeo di Emergenza).*
