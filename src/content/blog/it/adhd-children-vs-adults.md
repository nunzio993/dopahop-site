...
Per i pensieri che svaniscono prima ancora di poterli sistemare, [il brain dump di DopaHop](/#cosa-fa) li fissa in dieci secondi — non risolve l'ADHD, ma chiude un buco frequente di chi convive con la disattenzione adulta.
...
Vedi anche: [ADHD: criteri DSM-5 e definizione operativa](/blog/adhd-dsm-5-criteria/) per capire quali criteri usano davvero i clinici e come si arriva a una diagnosi.
...
Risorse italiane utili: l'**AIDAI** ([aidaiassociazione.com](https://aidaiassociazione.com/)) raccoglie contatti di centri e materiali; l'**Istituto Superiore di Sanità** ([iss.it](https://www.iss.it/)) pubblica materiali divulgativi e linee guida.
...
- **[Pomodoro](/#cosa-fa)** quando il problema non è "fare", è iniziare. Premi avvio e basta: il timer parte da solo.
