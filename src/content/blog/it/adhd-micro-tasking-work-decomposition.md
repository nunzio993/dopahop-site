---
title: "ADHD e micro-tasking: scomporre il lavoro in passi reali"
description: "ADHD e micro-tasking: perché i task grandi non partono, come scomporli in passi minimi, errori tipici della scomposizione e strumenti pratici per il quotidiano."
excerpt: "Il task grande non parte. Quello da 30 secondi sì. Ecco perché funziona e come farlo bene."
pubDate: 2026-08-23
updatedDate: 2026-08-23
tags: ["ADHD", "micro-tasking", "scomposizione task", "produttività", "memoria di lavoro"]
locale: it
draft: false
author: "Nunzio C."
translationKey: "adhd-micro-tasking-work-decomposition"
---
...
Se vuoi approfondire la parte sul "non riesco a partire", c'è già un pezzo dedicato: [ADHD procrastinazione: meccanismo reale, non pigrizia](/blog/adhd-procrastination-real-mechanism/).
...
1. **Durata percepita ≤ 5 minuti** (idealmente 30 secondi – 2 minuti per i primi passi).
2. **Verbo d'azione fisico/osservabile** ("apri", "scrivi una riga", "metti la cartella sul desktop"), non un concetto ("preparati", "organizza").
3. **Punto finale chiaro**: sai esattamente quando il passo è "fatto", senza dover decidere.
...
- "Apri Word, crea file vuoto, salvalo con nome `presentazione-15set.docx`"
- "Apri l'email del cliente X e copia il brief in un Google Doc"
- "Metti il libro di scuola di mio figlio sul tavolo della cucina" (per "aiutare con i compiti")
- "Apri Excel, scrivi nella cella A1 le parole `entrate ottobre`"
...
1. Apri Word, salva come `presentazione-15set.docx`
2. Scrivi sulla prima riga del documento il titolo della presentazione
3. Scrivi 3 bullet con i punti principali, senza preoccuparti dell'ordine
4. Riordina i bullet trascinandoli
5. Crea slide 1 (titolo) e slide 2 (i 3 bullet)
...
**Liste digitali minime.** Una nota sul telefono, un task manager basic. La regola è: **una sola lista visibile alla volta**. Se l'app ti mostra dieci progetti diversi con cinquanta sotto-task, il cervello ADHD va in *cognitive overload* prima ancora di iniziare. Su questo punto c'è già un articolo dedicato: [ADHD e strumenti digitali: i task manager funzionano davvero?](/blog/adhd-digital-tools-task-managers/).
...
Se sei al "non parto neanche oggi", prova [il Pomodoro di DopaHop](/#cosa-fa): premi avvio e il timer parte da solo, tu pensi solo al primo passo. Se invece il problema è che i pensieri sui passi successivi ti distraggono mentre lavori al primo, c'è il [brain dump](/#cosa-fa) — dieci secondi per buttarli fuori senza perdere il filo, li rivedi dopo. E per scomporre attivamente un compito troppo grande, DopaHop ha uno [spacca-task](/#cosa-fa) manuale: un wizard che ti accompagna passo per passo nella decomposizione (non è AI: lo fai tu, ma con una struttura che ti tiene sui binari).
