---
title: "ADHD lavoro: la performance discontinua spiegata bene"
description: "ADHD e lavoro: perché la performance è discontinua, hyperfocus e giorni vuoti, accomodamenti ragionevoli, scelta tra dipendente e freelance. Senza guru."
excerpt: "Giorni in cui spacchi tutto e giorni in cui non riesci a iniziare una mail. Non sei incoerente: c'è un pattern, e si può gestire."
pubDate: 2026-06-12
updatedDate: 2026-06-12
tags: ["ADHD", "lavoro", "hyperfocus"]
locale: it
draft: false
author: "Nunzio C."
...
Russell Barkley, psicologo e uno dei ricercatori più citati sull'ADHD adulto, descrive il disturbo come una **disabilità della performance, non della conoscenza**: sai cosa devi fare, sai come si fa, ma il sistema che dovrebbe attivarti nel momento giusto non parte in modo affidabile. Vedi anche: [Funzioni esecutive ADHD: cosa si rompe davvero in pratica](/blog/adhd-executive-functions-what-breaks/).
...
A questo si aggiunge la **disregolazione emotiva** (vedi [ADHD disregolazione emotiva: perché le emozioni arrivano forte](/blog/adhd-emotional-dysregulation/)): una mail brusca al mattino può rovinarti la curva di tutto il giorno, perché l'attivazione emotiva consuma le stesse risorse dell'attivazione esecutiva.
...
Questo si fa in trenta secondi al giorno con il [mood check-in di DopaHop](/#cosa-fa): tre tocchi e un tag, niente diari.
...
- **Quanto puoi tollerare l'incertezza economica?** Il freelance ADHD ha picchi di reddito e mesi vuoti — proprio come la curva di performance. Se l'instabilità ti destabilizza emotivamente (e [l'autostima](/blog/adhd-self-esteem-construction-distortions/) ne risente), un fisso mensile è più sostenibile.
...
- **[Mood check-in](/#cosa-fa)**: tre tocchi a fine giornata. Dopo due settimane vedi il pattern verde/giallo/rosso senza dover tenere un diario.
- **[Pomodoro](/#cosa-fa)**: per i giorni gialli, quando il cervello non parte da solo. Premi avvio, il timer parte, tu pensi solo a fare. Senza colpa se ti fermi.
- **[Brain dump](/#cosa-fa)**: per buttare fuori in 10 secondi le idee che arrivano in iperfocus su task laterali. Le rivedi dopo, senza rompere il flusso del task principale.
...
Prova solo una cosa per due settimane: il [mood check-in](/#cosa-fa) a fine giornata, tre tocchi. Vedi se il pattern verde/giallo/rosso diventa visibile. Se sì, allinea anche solo un task pesante alla fascia giusta. Niente di più, per ora.
