---
title: "ADHD e burnout: perché arriva prima e torna più spesso"
description: "ADHD e burnout: perché la dinamica è più rapida e ricorrente del burnout neurotipico, segnali specifici, differenza dalla depressione, prevenzione."
excerpt: "Il burnout nell'ADHD non è quello del manuale: arriva prima, torna più spesso, ti svuota in modo diverso."
pubDate: 2026-06-28
updatedDate: 2026-06-28
tags: ["ADHD", "burnout", "energia", "funzioni esecutive"]
locale: it
draft: false
author: "Nunzio C."
...
Vedi anche: [Funzioni esecutive ADHD: cosa si rompe davvero in pratica](/blog/adhd-executive-functions-what-breaks/) per capire da dove parte il costo cognitivo extra.
...
Per i task piccoli del quotidiano, può aiutare uno strumento esterno che ti tenga onesto. Per buttare fuori subito i pensieri "devo fare anche questo, e questo" prima che si sommino in pressione, prova [il brain dump di DopaHop](/#cosa-fa) — dieci secondi e l'hai fissato, lo rivedi quando hai testa per decidere.
...
Vedi anche: [ADHD e iperfocus: vantaggio o trappola, vediamo bene](/blog/adhd-iperfocus-vantaggio-o-trappola/) per il legame diretto tra cicli di iperfocus e crollo successivo.
