---
title: "ADHD e relazioni sentimentali: perché sono instabili"
description: "ADHD e relazioni sentimentali: perché iniziano fortissime e poi vacillano, RSD nei conflitti, asimmetria domestica, e cosa funziona davvero per entrambi."
excerpt: "Inizio fortissimo, poi la curva scende. Non è amore finito: è chimica del cervello che cambia."
pubDate: 2026-08-13
updatedDate: 2026-08-13
tags: ["ADHD", "relazioni", "coppia", "comunicazione"]
locale: it
draft: false
author: "Nunzio C."
...
Vedi anche [ADHD e relazioni: dinamiche tipiche in coppia e famiglia](/blog/adhd-relazioni-dinamiche-tipiche-coppia-famiglia/) per il quadro più ampio dei pattern relazionali.
...
Questo è particolarmente faticoso da reggere quando si combina con la disregolazione del sonno tipica dell'ADHD adulto: il partner ADHD si attiva la sera, lavora fino alle due, dorme male, si sveglia esausto. I ritmi della coppia si disallineano. Vedi [ADHD e sonno: ritmi circadiani alterati e cosa fare](/blog/adhd-sonno-ritmi-circadiani-alterati/) per come funziona dal lato neurobiologico.
...
- **Sistemi esterni invece di promesse interne.** Promemoria, calendario condiviso, brain dump per le cose che ti vengono in mente sul partner mentre sei al supermercato — così non svaniscono. Per buttare giù in dieci secondi un pensiero prima che evapori, c'è [il brain dump di DopaHop](/#cosa-fa).
...
- **[Brain dump](/#cosa-fa)**: butti giù in dieci secondi i pensieri sul partner che ti vengono in posti strani (treno, doccia, supermercato), così non svaniscono.
- **[Promemoria](/#cosa-fa)** per appuntamenti, anniversari, cose importanti per l'altro. Tre bottoni dalla notifica, niente loop di sgridate se salti.
- **[Routine](/#cosa-fa)** condivise per la sera (cena, riordino veloce, chiusura giornata) — l'app ti accompagna passo dopo passo, senza dover decidere ogni volta da dove iniziare.
