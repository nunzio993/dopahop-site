---
title: "ADHD e overload cognitivo: cosa succede in saturazione"
description: "ADHD e overload cognitivo: perché il cervello arriva prima alla saturazione, segnali fisici e cognitivi, strategie pratiche e differenza dal burnout."
excerpt: "Quando il cervello ADHD va in saturazione non sei pigro: hai esaurito la lavagnetta mentale. Vediamo cosa fare."
pubDate: 2026-08-03
updatedDate: 2026-08-03
tags: ["ADHD", "overload cognitivo", "carico mentale", "produttività"]
locale: it
draft: false
author: "Nunzio C."
translationKey: "adhd-cognitive-overload"
---
...
Vedi anche: [ADHD e memoria di lavoro: limiti reali, non bassa intelligenza](/blog/adhd-memoria-lavoro-limiti-reali/) per capire più nel dettaglio perché la lavagnetta mentale ha meno spazio.
...
1. **Filtro degli stimoli più permeabile.** Suoni, oggetti nel campo visivo, conversazioni di sfondo entrano nella memoria di lavoro anche quando non li stai osservando attivamente. Ogni stimolo non filtrato è uno slot in meno per quello che dovresti fare.

2. **Memoria di lavoro con margine ridotto.** Meno spazio per tenere attivi simultaneamente "cosa sto facendo", "cosa devo fare dopo", "dove ho messo le chiavi", "cosa mi ha detto la collega due minuti fa". Quando il margine si esaurisce, la prossima richiesta non rallenta il sistema: lo manda in stallo.

3. **Fatica decisionale a cascata.** Ogni micro-scelta (rispondo prima a questa o a quella mail? apro questo file o aspetto?) consuma controllo esecutivo. Più decisioni accumuli, meno controllo ti resta per la decisione successiva. È un effetto noto anche nei cervelli neurotipici, ma nell'ADHD parte da una base più stretta.
...
Per impostarle senza dover decidere ogni volta, [il Pomodoro di DopaHop](/#cosa-fa) parte con un tocco e ti accompagna sui 25 minuti di focus + 5 di pausa, senza richiedere altre decisioni.
...
Se ti riconosci più nel burnout che nell'overload, vedi: [ADHD e burnout: perché arriva prima e torna più spesso](/blog/adhd-burnout-arriva-prima-torna-spesso/).
