---
title: "ADHD procrastinazione: meccanismo reale, non pigrizia"
description: "ADHD e procrastinazione: cos'è davvero, perché non è pigrizia, cosa dicono dopamina, time blindness e funzioni esecutive, e cosa funziona nella vita reale."
excerpt: "La procrastinazione ADHD non è poca voglia: è un meccanismo neurobiologico preciso. Vediamolo bene."
pubDate: 2026-05-19
...
Vedi anche: [ADHD e dopamina: il modello neurobiologico spiegato](/blog/adhd-dopamine-neurobiological-model/).
...
Vedi anche: [Funzioni esecutive ADHD: cosa si rompe davvero in pratica](/blog/adhd-executive-functions-what-breaks/).
...
Se ti capita spesso di paralizzarti davanti a un compito grande, il modulo [Spacca-task di DopaHop](/#cosa-fa) è pensato esattamente per questo: ti fa decomporre manualmente un task in cinque passi piccoli, così il cervello vede solo il primo e non l'intera montagna.
...
- **[Pomodoro](/#cosa-fa)** — Timer 25/5. Materializza il tempo, abbassa la barriera dell'inizio. Premi avvio e basta: tu pensi solo a fare.
- **[Spacca-task](/#cosa-fa)** — Decomponi manualmente un task troppo grande in cinque passi concreti. *"Scrivi la tesi"* diventa *"apri il documento"*.
- **[Brain dump](/#cosa-fa)** — In dieci secondi butti fuori il pensiero che ti distrae mentre lavori, prima che svanisca o ti porti via dal compito.
